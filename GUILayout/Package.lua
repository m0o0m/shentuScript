...
function Package.main()
    ...
    _GUIHandle = GUI:ImageCreate(_Parent,"BindYuanBao_Img",1990240332,44,417)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetSizeM(_GUIHandle,23, 18)
    end
    _GUIHandle = GUI:EditCreate(_Parent,"BindYuanBao",87,420,130,22)
    if _GUIHandle ~= 0 then
		GUI:WndSetHint(_GUIHandle, "RMB")
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetImageID(_GUIHandle, 1806600016)
    end
    ...
    -- if _GUIHandle ~= 0 then
        ...
        -- GUI:WndSetImageID(_GUIHandle,1806600016)
    -- end
    -- _GUIHandle = GUI:ImageCreate(_Parent,"YinLiang_Img",1900710055,60,452)
    -- if _GUIHandle ~= 0 then
        -- GUI:WndSetParam(_GUIHandle, 0)
        -- GUI:WndSetSizeM(_GUIHandle,23, 18)
    -- end
	
    _GUIHandle = GUI:ImageCreate(_Parent,"YinLiang_Img",1900710055,238,422)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetSizeM(_GUIHandle,23, 18)
    end
	
    _GUIHandle = GUI:EditCreate(_Parent,"YinLiang",267,420,130,22)
    if _GUIHandle ~= 0 then
    ...
    _GUIHandle = GUI:ImageCreate(_Parent,"YuanBao_Img",1806600012,60,452)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetSizeM(_GUIHandle,23, 18)
    end 
	_GUIHandle = GUI:EditCreate(_Parent,"YuanBao",87,450,130,22)
    if _GUIHandle ~= 0 then
