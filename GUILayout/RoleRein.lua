...
function RoleRein.main()
    ...
    _GUIHandle = GUI:ImageCreate(_Parent,"ReinBackImg",1805900002,35,56)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
    ...
    _GUIHandle = GUI:ImageCreate(_Parent,"ReinLevelImg1",1805900042,254,99)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
    ...
    _GUIHandle = GUI:ImageCreate(_Parent,"LevelImg1",1805900043,405,100)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
    ...
    _GUIHandle = GUI:ImageCreate(_Parent,"LevelImg2",0,419,100)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetSizeM(_GUIHandle,22, 29)
        GUI:ImageSetParam(_GUIHandle, 0)
    ...
    _GUIHandle = GUI:ButtonCreate(_Parent,"ReinBtn",1805900100,279,438)
    if _GUIHandle ~= 0 then
        GUI:WndRegistScript(_GUIHandle,RDWndBaseCL_mouse_lbUp, "RoleRein.ReinB")
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetSizeM(_GUIHandle,132, 57)
        GUI:ButtonSetDownTextPosChange(_GUIHandle, false)
    end
    
    _GUIHandle = GUI:ImageCreate(_Parent,"ConsumePointImg",1805900018,279,375)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
    ...
    _GUIHandle = GUI:ImageCreate(_Parent,"HavePointImg",1805900018,279,408)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetSizeM(_GUIHandle,130, 22)
        GUI:ImageSetParam(_GUIHandle, 0)
    ...
    _GUIHandle = GUI:ImageCreate(_Parent,"ToImg",1800000366,316,235)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NowValueNameEdit1",138,195,65,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NowValueNameEdit2",138,217,65,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetTextColorM(_GUIHandle, 4291801952)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NowValueNameEdit3",138,239,65,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetTextColorM(_GUIHandle, 4291801952)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NowValueNameEdit4",138,261,65,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetTextColorM(_GUIHandle, 4291801952)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NowValueNameEdit5",138,283,65,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetTextColorM(_GUIHandle, 4291801952)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NowValueNameEdit6",138,305,65,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetTextColorM(_GUIHandle, 4291801952)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NowValueEdit1",204,195,80,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:EditSetCanEdit(_GUIHandle, false)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NowValueEdit2",204,217,80,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:EditSetCanEdit(_GUIHandle, false)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NowValueEdit3",204,239,80,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:EditSetCanEdit(_GUIHandle, false)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NowValueEdit4",204,261,80,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:EditSetCanEdit(_GUIHandle, false)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NowValueEdit5",204,283,80,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:EditSetCanEdit(_GUIHandle, false)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NowValueEdit6",204,305,80,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:EditSetCanEdit(_GUIHandle, false)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NextValueNameEdit1",399,195,65,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetTextColorM(_GUIHandle, 4291801952)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NextValueNameEdit2",399,217,65,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetTextColorM(_GUIHandle, 4291801952)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NextValueNameEdit3",399,239,65,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetTextColorM(_GUIHandle, 4291801952)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NextValueNameEdit4",399,261,65,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetTextColorM(_GUIHandle, 4291801952)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NextValueNameEdit5",399,283,65,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetTextColorM(_GUIHandle, 4291801952)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NextValueNameEdit6",399,305,65,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetTextColorM(_GUIHandle, 4291801952)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NextValueEdit1",465,195,80,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:EditSetCanEdit(_GUIHandle, false)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NextValueEdit2",465,217,80,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:EditSetCanEdit(_GUIHandle, false)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NextValueEdit3",465,239,80,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:EditSetCanEdit(_GUIHandle, false)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NextValueEdit4",465,261,80,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:EditSetCanEdit(_GUIHandle, false)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NextValueEdit5",465,283,80,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:EditSetCanEdit(_GUIHandle, false)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"NextValueEdit6",465,305,80,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:EditSetCanEdit(_GUIHandle, false)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"ConsumePointNameEdit",211,379,65,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetTextColorM(_GUIHandle, 4291801952)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"HavePointNameEdit",211,412,65,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetTextColorM(_GUIHandle, 4291801952)
    ...
    _GUIHandle = GUI:ButtonCreate(_Parent,"ConvertPointBtn",1800000150,484,412)
    if _GUIHandle ~= 0 then
        GUI:WndRegistScript(_GUIHandle,RDWndBaseCL_mouse_lbUp, "RoleRein.RoleReinPoint")
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"ConsumePointEdit",274,379,140,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:EditSetCanEdit(_GUIHandle, false)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"HavePointEdit",274,412,140,16)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:EditSetCanEdit(_GUIHandle, false)
