...
-----------------------图标显示-----------------------------
function huishou_xianshi(player)	
	AddSEIcon(player, 1, -1, "元宝回收", 1906100101, "元宝回收表单", "show_huishou", "", "元宝回收装备")
	AddIconMagic(player, "元宝回收", 1094200000, -6, -6, 150)

	-- ShowTimeCount3(player, 0, 1906100101, "回收装备",5,"","回收装备") --显示目标图标
end
-------------------图标被点击-----------------------
function show_huishou(player)
	init(player);
	return ""
end
