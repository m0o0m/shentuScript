HeroProtectSetting = {}
function HeroProtectSetting.main()
    ...
    if _GUIHandle ~= 0 then
        ...
        GUI:WndSetSizeM(_GUIHandle,577, 226)
    end
    
    
    _GUIHandle = GUI:ComboBoxCreate(_Parent,"Combox0",1906300014,59,22,130,20,78)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:ComboBoxSetListLength(_GUIHandle,78)
        GUI:ComboBoxSetScrollBarImage(_GUIHandle,1900100104,1900100108,1900100100,0)
    end
    
   
    _GUIHandle = GUI:ComboBoxCreate(_Parent,"Combox1",1906300014,58,51,130,20,78)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:ComboBoxSetListLength(_GUIHandle,78)
        GUI:ComboBoxSetScrollBarImage(_GUIHandle,1900100104,1900100108,1900100100,0)
    ...
    _GUIHandle = GUI:ComboBoxCreate(_Parent,"Combox2",1906300014,58,81,129,20,78)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:ComboBoxSetListLength(_GUIHandle,78)
        GUI:ComboBoxSetScrollBarImage(_GUIHandle,1900100104,1900100108,1900100100,0)
    ...
    _GUIHandle = GUI:ComboBoxCreate(_Parent,"Combox3",1906300014,58,111,129,20,78)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:ComboBoxSetListLength(_GUIHandle,78)
        GUI:ComboBoxSetScrollBarImage(_GUIHandle,1900100104,1900100108,1900100100,0)
    ...
    _GUIHandle = GUI:ComboBoxCreate(_Parent,"Combox4",1906300014,58,165,128,20,78)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:ComboBoxSetListLength(_GUIHandle,78)
        GUI:ComboBoxSetScrollBarImage(_GUIHandle,1900100104,1900100108,1900100100,0)
    ...
    _GUIHandle = GUI:ComboBoxCreate(_Parent,"Combox5",1906300014,58,195,130,20,78)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:ComboBoxSetListLength(_GUIHandle,78)
        GUI:ComboBoxSetScrollBarImage(_GUIHandle,1900100104,1900100108,1900100100,0)
    ...
    _GUIHandle = GUI:ComboBoxCreate(_Parent,"Combox6",1906300014,58,225,130,20,78)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:ComboBoxSetListLength(_GUIHandle,78)
        GUI:ComboBoxSetScrollBarImage(_GUIHandle,1900100104,1900100108,1900100100,0)
    ...
    _GUIHandle = GUI:ComboBoxCreate(_Parent,"Combox7",1906300014,58,255,130,20,78)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:ComboBoxSetListLength(_GUIHandle,78)
        GUI:ComboBoxSetScrollBarImage(_GUIHandle,1900100104,1900100108,1900100100,0)
    ...
    HeroProtectSetting.UIInit(_Parent)
end

--UI Logic Code Start
function HeroProtectSetting.UIInit(_Handle)
end
HeroProtectSetting.main()