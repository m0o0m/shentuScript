...
function HeroPropertyGUI.main()
    ...
    if _GUIHandle ~= 0 then
        ...
        GUI:WndSetImageID(_GUIHandle,1906200018)
    end
    ...
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetSizeM(_GUIHandle,184, 22)
    end
    ...
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetImageID(_GUIHandle,1906200017)
    end
    ...
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetSizeM(_GUIHandle,74, 9)
    end
    ...
    HeroPropertyGUI.UIInit(_Parent)
end

--UI Logic Code Start
function HeroPropertyGUI.UIInit(_Handle)
end
HeroPropertyGUI.main()