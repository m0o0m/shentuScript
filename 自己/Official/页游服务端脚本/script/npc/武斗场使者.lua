...
local talk_t = {"在武斗场内战斗，死亡后无损失，可以尽情地PK，是练习战斗的好场所。", "武斗场是中低级玩家获得好装备的捷径。", "想要证明你的能力，就来武斗场展示一下自己吧，还有很不错的奖励哦。"}
...
function main(npc, player)
	local msg = "    武斗场内定时刷出装备等你拾取，并且持续增加经验，但你将遭遇其它玩家的争夺！这是只有勇者才能欢呼的战场！\n"
	msg = msg.."#COLORCOLOR_YELLOW#━━━━━━━━━━━━━━━━━━━━━━━━━━━━━#COLOREND#\n \n"
	msg = msg.."#OFFSET<X:0,Y:-5>##IMAGE<ID:1902700018>##OFFSET<X:0,Y:-1>#<@enter *01*[进入武斗场]>\n"
