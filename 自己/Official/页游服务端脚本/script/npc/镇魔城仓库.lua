...
function main(npc, player)
    local msg = "    喔......你的包裹又满了吗？赶快存到我这儿吧，咱诚信为本，绝不会监守自盗哦！\n"
    msg = msg.."#COLORCOLOR_BROWN#────────────────────────────#COLOREND#\n \n"
    msg = msg.."#OFFSET<X:40,Y:2>##IMAGE1902700037##OFFSET<X:0,Y:-1>#<@InfoWarehouse *01*「打开仓库」>#OFFSET<X:50,Y:1>##IMAGE1902700037##OFFSET<X:0,Y:-1>#<@InfoWarehouseAdv *01*「高级仓库」>\n #OFFSET<X:34,Y:1>##IMAGE1902700037##OFFSET<X:0,Y:-1>#<@Jin_DH *01*「金币兑换」>#OFFSET<X:50,Y:1>##IMAGE1902700037##OFFSET<X:0,Y:-1>#<@Bao_Pro *01*「包裹制作」>\n"
    msg = msg.."#OFFSET<X:40,Y:1>##IMAGE1902700037#<@zhanghaoanquan *01*「账号安全」>\n "
...
local talk_t = {"只有职业传承者才能使用仓库，那些贩夫走卒等普通人是不行的。", "仓库管理员是一个很好的职业，我对此充满了使命感！", "东西越来越多，最近仓库有些不够用了，你可以买些存储箱来扩充高级仓库。"}
...
function ExchangeGold(npc_guid, player_guid)
	...
	if lualib:Player_GetBagFree(player_guid) < 1 then return "背包满了！\n \n \n \n \n \n \n \n \n                                                   #OFFSET<X:0,Y:-3>##IMAGE1902700019##OFFSET<X:0,Y:-2>#<@Jin_DH *01*「返回」>" end
	...
	return "金币「兑换」金条成功！\n \n \n \n \n \n \n #OFFSET<X:0,Y:-4>##IMAGE1902700037#<@ExchangeGold *01*[继续兑换]>\n \n                                                   #OFFSET<X:0,Y:-3>##IMAGE1902700019##OFFSET<X:0,Y:-2>#<@Jin_DH *01*「返回」>"
end
