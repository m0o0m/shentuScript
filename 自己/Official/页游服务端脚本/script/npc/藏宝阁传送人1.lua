...
function main(player, npc)
	...
	msg = msg.." #OFFSET<X:0,Y:5>##IMAGE1902700015##OFFSET<X:0,Y:-1>#<@jump#异兽栏#22#39#5 *01*前往异兽栏(稀有坐骑抓捕)>\n"
	msg = msg.." #OFFSET<X:0,Y:5>##IMAGE1902700015##OFFSET<X:0,Y:-1>#<@jump#珍宝洞#27#104#5 *01*前往珍宝洞(各种精炼道具)>\n"
	msg = msg.." #OFFSET<X:0,Y:5>##IMAGE1902700015##OFFSET<X:0,Y:-1>#<@jump#百草堂#18#27#5 *01*前往百草堂(各种高级药品)>\n"
	msg = msg.." #OFFSET<X:0,Y:5>##IMAGE1902700015##OFFSET<X:0,Y:-1>#<@jump#修炼场#62#69#5 *01*前往修炼场(升级加速道具)>\n"
    msg = msg.." #OFFSET<X:0,Y:5>##IMAGE1902700015##OFFSET<X:0,Y:-1>#<@jump#锁魔宫#158#160#5 *01*前往锁魔宫(挑战各种boss)>\n"
	msg = msg.." #OFFSET<X:0,Y:5>##IMAGE1902700015##OFFSET<X:0,Y:-1>#<@jump#龙城#234#226#5 *01*返回龙城>\n \n"
