...
function main(npc, player)
	...
	msg = msg.."    35级后，你可每天到我这里来免费押送3次镖，完成后会获得大量的非绑定金币，以及大量特殊物品哦！\n"
    msg = msg.."#COLORCOLOR_BROWN#▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂#COLOREND#\n \n"
...
function jieshao(npc, player)
	local msg = "35级后，你可每天到我这里来免费押送3次镖，完成后会获得大量的非绑定金币，以及大量特殊物品哦！\n"
	msg = msg.."#COLORCOLOR_BROWN#▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂#COLOREND#\n"
...
function RefreshEx(npc, player, color, ingot, old_color)
    ...
    if Escorter.color_flag[cur_color][5] then
		...
		lualib:SysMsg_SendBroadcastColor("#COLORCOLOR_BROWN#["..lualib:Name(player).."] #COLORCOLOR_YELLOW#接到了#COLORCOLOR_BROWN#"
                                       ..Escorter.color_flag[cur_color][4]..
        " #COLORCOLOR_YELLOW#任务，祝他一路顺风！嘿嘿，希望劫镖的玩家看不见他……看不见他……", "", 1, 12)
    end
