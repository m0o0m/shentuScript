...
function main(player_guid, item_guid)
	...
	local item_zs = {"绑钱袋(5万)", "灵元珠", "祝福神水", "1.5倍经验卷轴", "铁战戒指", "坐骑口粮", "套索", "小喇叭", "新手35级礼包"}
	local item_fs = {"绑钱袋(5万)", "灵元珠", "祝福神水", "1.5倍经验卷轴", "聚魂戒指", "坐骑口粮", "套索", "小喇叭", "新手35级礼包"}
	local item_ds = {"绑钱袋(5万)", "灵元珠", "祝福神水", "1.5倍经验卷轴", "玄光戒指", "坐骑口粮", "套索", "小喇叭", "新手35级礼包"}
	local item_count = {1, 				3, 		  1, 				1, 			 1,			25,		  5,		3, 			1}
