...
function main(player, item)
	...
	local msg = "#OFFSET<X:80,Y:-0>##COLORCOLOR_BROWN#[队友召集令]#COLOREND#\n"

	msg = msg .."#OFFSET<X:70,Y:0>##COLORCOLOR_RED#功能调整中，敬请期待……#COLOREND#"
	--[[
	...
	msg = msg .. "#IMAGE<ID:1902700033>##COLORCOLOR_BROWN#点击#IMAGE<ID:1902700015>#可将队友成员拉到自己身旁#COLOREND#\n#OFFSET<X:0,Y:5>#"  
	...
	for k, v in pairs(player_team) do
		...
		msg = msg .. "#IMAGE<ID:1902700015>#".."#OFFSET<X:-22,Y:-1>#<@chuansong".."#"..Team_name.."#"..v.."#"..item.."#"..map_name.. " *01* 传>".."→#COLORCOLOR_GREENG#["..Team_name.."]#COLOREND# 在["..map_name.."]\n"
	end]]
...
function chuansong(player, Team_name, v, item, map_name)
	...
	if not lualib:Player_SubGold(player, gold, false, "行会召集", player) then
		lualib:SysTriggerMsg(player, "金币扣除失败")
		return ""
	end
...
function chuansong_all(player, item)
	...
	if not lualib:Player_SubGold(player, gold_all, false, "行会召集", player) then
		lualib:SysTriggerMsg(player, "金币扣除失败")
		return ""
	end
