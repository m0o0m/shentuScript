...
local request_slots = 6
	local item_array_man   = {"1.5倍经验卷轴", "强效金创药包", "强效魔法药包", "绑钱袋(1万)", "乾坤囊(10格)", "新手20级礼包"}
	local item_array_woman = {"1.5倍经验卷轴", "强效金创药包", "强效魔法药包", "绑钱袋(1万)", "乾坤囊(10格)", "新手20级礼包"}
	local item_count = {			1, 	 			1,			 1, 			1,					1,				1}
