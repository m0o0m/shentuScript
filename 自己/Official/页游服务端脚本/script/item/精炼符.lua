...
local attTypeList = {
						["低级HP精炼符"]   = {lua_role_max_hp_pct,       500,   {5, 6, 7},  {5000, 8000, 10000}},
						["中级HP精炼符"]   = {lua_role_max_hp_pct,       1200,  {6, 7, 8},  {5000, 8000, 10000}},
						["高级HP精炼符"]   = {lua_role_max_hp_pct,       4000,  {7, 8, 9},  {5000, 8000, 10000}},
						["低级MP精炼符"]   = {lua_role_max_mp_pct,       500,   {5, 6, 7},  {5000, 8000, 10000}},
						["中级MP精炼符"]   = {lua_role_max_mp_pct,       1200,  {6, 7, 8},  {5000, 8000, 10000}},
						["高级MP精炼符"]   = {lua_role_max_mp_pct,       4000,  {7, 8, 9},  {5000, 8000, 10000}},
                        ["低级物攻精炼符"] = {lua_role_max_phy_atk_pct,  500,   {5, 6, 7},  {5000, 8000, 10000}},
						["中级物攻精炼符"] = {lua_role_max_phy_atk_pct,  1200,  {6, 7, 8},  {5000, 8000, 10000}},
						["高级物攻精炼符"] = {lua_role_max_phy_atk_pct,  4000,  {7, 8, 9},  {5000, 8000, 10000}},
                        ["低级魔攻精炼符"] = {lua_role_max_mag_atk_pct,  500,   {5, 6, 7},  {5000, 8000, 10000}},
						["中级魔攻精炼符"] = {lua_role_max_mag_atk_pct,  1200,  {6, 7, 8},  {5000, 8000, 10000}},
						["高级魔攻精炼符"] = {lua_role_max_mag_atk_pct,  4000,  {7, 8, 9},  {5000, 8000, 10000}},
                        ["低级道术精炼符"] = {lua_role_max_tao_atk_pct,  500,   {5, 6, 7},  {5000, 8000, 10000}},
						["中级道术精炼符"] = {lua_role_max_tao_atk_pct,  1200,  {6, 7, 8},  {5000, 8000, 10000}},
						["高级道术精炼符"] = {lua_role_max_tao_atk_pct,  4000,  {7, 8, 9},  {5000, 8000, 10000}},
                        ["低级物防精炼符"] = {lua_role_max_phy_def_pct,  500,   {5, 6, 7},  {5000, 8000, 10000}},
						["中级物防精炼符"] = {lua_role_max_phy_def_pct,  1200,  {6, 7, 8},  {5000, 8000, 10000}},
						["高级物防精炼符"] = {lua_role_max_phy_def_pct,  4000,  {7, 8, 9},  {5000, 8000, 10000}},
                        ["低级魔防精炼符"] = {lua_role_max_mag_def_pct,  500,   {5, 6, 7},  {5000, 8000, 10000}},
						["中级魔防精炼符"] = {lua_role_max_mag_def_pct,  1200,  {6, 7, 8},  {5000, 8000, 10000}},
						["高级魔防精炼符"] = {lua_role_max_mag_def_pct,  4000,  {7, 8, 9},  {5000, 8000, 10000}},
					}
...
function on_apply_on_item(player, item, target_item)
	...
	if refine_level > attTypeList[itemName][3][#attTypeList[itemName][3]] then
