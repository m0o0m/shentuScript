...
local request_slots = 7
	local item_array_man   = {"1.5倍经验卷轴", "小喇叭", "祝福神水", "封印鉴定符" ,"灵元珠", "开光印", "坐骑经验丹"}
	local item_array_woman = {"1.5倍经验卷轴", "小喇叭", "祝福神水", "封印鉴定符" ,"灵元珠", "开光印", "坐骑经验丹"}
    --1.5倍经验卷轴*5、小喇叭*10、祝福神水*2、封印鉴定符*2、灵元珠*20、开光印*2、坐骑经验丹*10
