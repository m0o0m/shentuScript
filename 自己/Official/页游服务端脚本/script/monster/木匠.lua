...
function main(monster, player)
	lualib:SysMsg_SendRoleTalk(monster, "我的手工活可是一流哟！想变废为宝，找我没错！")
	local msg = "#COLORCOLOR_BROWN#━━━━━━━━━━━━━━━#COLOREND##COLORCOLOR_SKYBLUE#木匠#COLOREND##COLORCOLOR_BROWN#━━━━━━━━━━━━━━━#COLOREND#\n"
	msg = msg .. "我可是一把好手哟~可以将你的垃圾装备变废为宝！只要你在#COLORCOLOR_GREENG#包裹前10格#COLOREND#放入你想变宝的#COLORCOLOR_RED#装备#COLOREND#，我就能给你打造出一些#COLORCOLOR_YELLOW#特殊的玩意#COLOREND#！想让我帮你制造吗？\n"
	msg = msg .. "#OFFSET<X:0,Y:10>##IMAGE1902700037#<@zhizao#"..player.. "#*01* [制造神秘玩意儿]>\n"
...
function zhizao(monster, player)
...
local yd = {"花蜘蛛变身卡", "顽猴变身卡", "飞芒变身卡", "赤面猴变身卡", "巨蛾变身卡", "野狼变身卡", "黑水蛇变身卡", "墓地蛆虫变身卡", "鹿变身卡", "毒蜘蛛变身卡", "天狼蜘蛛变身卡", "泼猴变身卡", "凶暴猿猴变身卡", "猿猴变身卡", "飞蛾变身卡", "毒蛾变身卡", "苍狼变身卡", "青蛇变身卡", "红蛇变身卡", "白蛇变身卡", "蟒蛇变身卡", "蛇蛟变身卡", "飞萤变身卡", "魔萤变身卡", "邪翅变身卡", "老母猪变身卡", "小猪变身卡", "羊变身卡", "牛变身卡", "鸡变身卡", "饿鬼蛛变身卡", "剧毒蛛变身卡", "魔蛇变身卡", "魔狼变身卡", "魔猿变身卡", "魔化蜥蜴变身卡", "魔化蝎子变身卡", "魔化沙虫变身卡", "天魔妖蟒变身卡", "石甲鱼变身卡", "巨钳蟹变身卡", "铁棘鱼变身卡"}

local ed = {"白茅人变身卡", "木器人变身卡", "蛟人变身卡", "邪魔人偶变身卡", "树妖变身卡", "噬灵妖花变身卡", "妖面监工变身卡", "鬼面监工变身卡", "妖刀侍卫变身卡", "红面牛魔变身卡", "刀奴变身卡", "散兵变身卡", "沙石魔变身卡", "风魔变身卡", "夜行僧变身卡", "黑暗刺客变身卡", "天原死士变身卡", "飞刀骷髅变身卡", "尸奴工头变身卡", "僵尸变身卡", "雷暴僵尸变身卡", "白茅怪人变身卡", "白茅邪人变身卡", "古怪刀客变身卡", "鬼面刀手变身卡", "双刀侩子手变身卡", "魔兵变身卡", "蓝兽变身卡", "妖僧变身卡", "鬼面武者变身卡", "影刺变身卡", "骷髅战士变身卡", "单刀骷髅变身卡", "大斧骷髅变身卡", "食人花变身卡", "天原勇士变身卡", "天原猛士变身卡", "黑面牛魔变身卡", "牛魔勇士变身卡", "牛魔守卫变身卡", "爬尸变身卡", "尸卫变身卡", "腐尸变身卡", "掘铲尸奴变身卡", "铁镐尸奴变身卡", "尸奴变身卡", "天魔奴仆变身卡", "天魔统领变身卡", "天魔守卫变身卡", "天魔妖道变身卡", "天魔先锋变身卡", "秘境海妖变身卡", "海魔侍从变身卡", "海魔护卫变身卡", "秘境歌妖变身卡", "铁螯怪变身卡"}

local sd = {"铁齿战将变身卡", "绝道白猿变身卡", "神兽变身卡", "牛魔将军变身卡", "巨蛇变身卡", "白狼变身卡", "梵天僧变身卡", "血禅师变身卡", "骷髅王变身卡", "幽冥尸王变身卡", "千年树魔变身卡", "巨石傀儡变身卡", "牛魔侍卫变身卡", "恶战天魔变身卡", "夜灵变身卡", "天魔神变身卡", "深海巨螯怪变身卡", "骷髅战将变身卡", "骷髅宝宝变身卡"}
	...
	for i = 1, #item_keyname do
		if not lualib:DelItem(player, item_keyname[i], 1, 2, "木匠制造扣除装备", player) then
			lualib:MsgBox(player, "很遗憾，制造失败！")
		end
	end

		
	if sum < 10000 then
		if not lualib:AddItem(player, yd[lualib:GenRandom(1, #yd)], 1, false, "木匠制造玩意儿", player) then
			lualib:MsgBox(player, "很遗憾，制造失败！")
		end
		lualib:SysMsg_SendCenterMsg(1, "["..player.."]→→在[木匠]处用垃圾装备制造出了一个神秘的玩意儿！", "")
		lualib:MsgBox(player, "制造成功！请查看包裹！")
	elseif sum >= 10000 and sum < 50000 then
		if not lualib:AddItem(player, ed[lualib:GenRandom(1, #ed)], 1, false, "木匠制造玩意儿", player) then
			lualib:MsgBox(player, "很遗憾，制造失败！")
		end
		lualib:SysMsg_SendCenterMsg(1, "["..player.."]→→在[木匠]处用垃圾装备制造出了一个神秘的玩意儿！", "")
		lualib:MsgBox(player, "制造成功！请查看包裹！")
	elseif sum >= 50000 then
		if not lualib:AddItem(player, sd[lualib:GenRandom(1, #sd)], 1, false, "木匠制造玩意儿", player) then
			lualib:MsgBox(player, "很遗憾，制造失败！")
		end
		lualib:SysMsg_SendCenterMsg(1, "["..player.."]→→在[木匠]处用垃圾装备制造出了一个神秘的玩意儿！", "")
		lualib:MsgBox(player, "制造成功！请查看包裹！")
