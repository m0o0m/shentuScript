...
function on_trigger_boss_born(monster)
    lualib:SysMsg_SendRoleTalk(monster, "树魔已经在灵山出现！打败树魔能够获得大量玫瑰花！各路勇士可以找巫山城[241.389]的红娘进入地图！")
...
function AtkOnHp(monster, timer_id)
		...
		lualib:SysMsg_SendBroadcastColor("树魔：让你们尝尝我的厉害！", "", 1, 12)
		lualib:SysMsg_SendRoleTalk(monster, "树魔：让你们尝尝我的厉害！")
		if     timer_id == 1 then
