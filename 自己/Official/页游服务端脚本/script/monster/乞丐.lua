...
function main(monster, player)
	lualib:SysMsg_SendRoleTalk(monster, "能施舍点吗？我有惊喜给你哟！")
	local msg = "#COLORCOLOR_BROWN#━━━━━━━━━━━━━━━#COLOREND##COLORCOLOR_SKYBLUE#乞丐#COLOREND##COLORCOLOR_BROWN#━━━━━━━━━━━━━━━#COLOREND#\n"
	msg = msg .. "别看我如今如此矮穷锉，可我曾经也做过高富帅，甚至还有一些宝贝藏着呢！只要你肯施舍点钱给我，我说不定会给你意外的惊喜哦！\n"
	msg = msg .. "#OFFSET<X:0,Y:10>##IMAGE1902700037#<@shishe#"..player.. "#*01* [施舍]>\n"
...
function shishe(monster, player)
	lualib:SysMsg_SendInputDlg(player, 1234, "只要输中乞丐心中想要的数字，就会获得乞丐珍藏的宝贝喔！", 45, 5, "EnterHot", "")
...
function EnterHot(id, player, player_num)
	local player_num = tonumber(player_num)
	if player_num == nil or player_num < 1000 or player_num%1 ~= 0 then
		lualib:MsgBox(player, "请输入大于等于1000的数字！")
		return 
	end
	
	if not lualib:Player_SubGold(player, player_num, false, "施舍给乞丐金币", player) then
		lualib:MsgBox(player, "乞丐说：钱还没哥多，不要拿过来秀！")
	end
	
	local qigai_num = lualib:GenRandom(1000, 15000)

	
			
	if player_num ~= qigai_num then
		lualib:MsgBox(player, "乞丐这次想要：#COLORCOLOR_RED#"..qigai_num.."#COLOREND#\n很遗憾，你施舍的钱是：#COLORCOLOR_GREENG#"..player_num.."#COLOREND#\n不是乞丐这次想要的!\n没有获得乞丐的宝贝！")
	else
		lualib:SysMsg_SendCenterMsg(1, "["..player.."]→→猜对了[乞丐]心中的数字！获得了一份用人民币也买不到的超级大礼！", "")
		lualib:MsgBox(player, "恭喜你猜中了乞丐心中的数字！#COLORCOLOR_GREENG#"..qigai_num.."#COLOREND#\n乞丐赠送予你了神秘礼物和称号！")
		lualib:AddTitle(player, 80) --给称号
		if not lualib:AddItem(player,jl[lualib:GenRandom(1, 6)],1,false,"施舍乞丐得物品", player) then --给物品 
			msg = msg .. "你包裹满了或是其它情况，导致乞丐法正常送你宝贝！\n \n"
		end
	end
