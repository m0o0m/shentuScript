...
function on_create(monster)
	...
	local npc = lualib:Map_GenNpc(map, "³ÇÃÅ×èµ²", 90, 113, 0, 1)
	if npc == "" then
	...
	npc = lualib:Map_GenNpc(map, "³ÇÃÅ×èµ²", 91, 113, 0, 1)
	if npc == "" then
        lualib:Error("Ë¢Éñ¸è³Ç»Ê¹¬ÃÅ²¹Â©×èµ²Ê§°Ü£¡")
        return
    end
	...
	npc = lualib:Map_GenNpc(map, "³ÇÃÅ×èµ²", 91, 112, 0, 1)
	if npc == "" then
        lualib:Error("Ë¢Éñ¸è³Ç»Ê¹¬ÃÅ²¹Â©×èµ²Ê§°Ü£¡")
        return
    end
	lualib:SetStr(monster, "npc3", npc)
