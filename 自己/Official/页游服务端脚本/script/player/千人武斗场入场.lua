...
--[[
	...
	if level < 20 or level >= 35 then return end
	
	lualib:SysMsg_SendTriggerMsg(player, "你收到了\"千人武斗场入场\"邀请！")
	...
	local msg = "千人武斗场入场开始了！活动产出大量#COLORCOLOR_RED#装备、道具、经验#COLOREND#，你要参加么？\n \n"
