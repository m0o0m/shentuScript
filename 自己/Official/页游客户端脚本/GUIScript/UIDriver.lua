...
function UIDriver_Jiaoben_OnShowForm()
	if as3.tolua(LuaParam[1]) ~= "脚本表单" then return end
	local str = as3.tolua(LuaParam[2])
...
function UIDriver_Forminfo_OnShowForm()
	if as3.tolua(LuaParam[1]) ~= "form内容表单" then return end
	local str = as3.tolua(LuaParam[2])
...
function UIDriver_Formfile_OnShowForm()
	if as3.tolua(LuaParam[1]) ~= "form文件表单" then return end
	local str = as3.tolua(LuaParam[2])
	UI:Lua_GenForm(str)
end
...
function UIDriver_LtsSelfInfo_OnShowForm()
	if as3.tolua(LuaParam[1]) ~= "个人竞技场信息表单" then return end
...
function UIDriver_FmsxsWnd_OnShowForm()
	if as3.tolua(LuaParam[1]) ~= "附魔石吸收表单" then return end
...
function UIDriver_RyzbduihuanWnd_OnShowForm()
	if as3.tolua(LuaParam[1]) ~= "荣耀装备兑换表单" then return end
...
function UIDriver_RyzbwupinWnd_OnShowForm()
	if as3.tolua(LuaParam[1]) ~= "荣耀装备兑换内容表单" then return end
	local func = loadstring(as3.tolua(LuaParam[2]))
	func()
	if GetWindow(nil, "荣耀装备兑换") ~= 0 then
		LuaUI["荣耀装备兑换"].Update()
	end
...
function UIDriver_JiaoyipingtaiWnd_OnShowForm()
	if as3.tolua(LuaParam[1]) ~= "交易平台表单" then return end
	local style = as3.tolua(LuaParam[2])
...
function UIDriver_Wuqihecheng_OnShowForm()
	if as3.tolua(LuaParam[1]) ~= "武器合成表单" then return end
	LuaParam[3] = 1
...
function UIDriver_Yifuhecheng_OnShowForm()
	if as3.tolua(LuaParam[1]) ~= "衣服合成表单" then return end
	LuaParam[3] = 2
	if GetWindow(nil, "装备合成") ~= 0 then
		WndClose(nil, "装备合成")
	end
...
function UIDriver_Zbhechengneirong_OnShowForm()
	if as3.tolua(LuaParam[1]) ~= "装备合成内容表单" then return end
	local func = loadstring(as3.tolua(LuaParam[2]))
	func()
	LuaUI["装备合成"].Update()
end
...
function UIDriver_Daojunhecheng_OnShowForm()
	if as3.tolua(LuaParam[1]) ~= "道具合成表单" then return end
...
function UIDriver_Djhechengneirong_OnShowForm()
	if as3.tolua(LuaParam[1]) ~= "道具合成内容表单" then return end
	local func = loadstring(as3.tolua(LuaParam[2]))
	func()
	LuaUI["道具合成"].Update()
end
...
--双旦活动--
function UIDriver_RyzbduihuanWnd_OnShowForm()
	if as3.tolua(LuaParam[1]) ~= "双旦活动" then return end
...
--转生表单--
function UIDriver_RyzbduihuanWnd_OnShowForm()
	if as3.tolua(LuaParam[1]) ~= "转生表单" then return end
