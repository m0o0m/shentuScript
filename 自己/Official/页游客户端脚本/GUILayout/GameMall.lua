...
local ui = "<form> <dialog OnInit='GameMall.UIInit' id='GameMall' image='1804100002' w='916' h='621' esc_close='true' center='true' drag='true' revmsg='true'>"
	...
	.."	<button id='SortBuy0' image='1804100010' x='780' y='248' w='78' h='30' OnLButtonUp='GameMall.OnSortButItem' revmsg='true' text='购买' text_color='#C2B6A0'/>"
	.."	<button id='SortBuy1' image='1804100010' x='780' y='365' w='78' h='30' OnLButtonUp='GameMall.OnSortButItem' revmsg='true' param='1' text='购买' text_color='#C2B6A0'/>"
	.."	<button id='SortBuy2' image='1804100010' x='780' y='483' w='78' h='30' OnLButtonUp='GameMall.OnSortButItem' revmsg='true' param='2' text='购买' text_color='#C2B6A0'/>"
	...
	.."	<button id='Buy0' image='1804100010' x='162' y='223' w='78' h='30' OnLButtonUp='GameMall.OnBuyItem' revmsg='true' text='购买' text_color='#C2B6A0'/>"
	.."	<button id='Buy1' image='1804100010' x='360' y='223' w='78' h='30' OnLButtonUp='GameMall.OnBuyItem' revmsg='true' param='1' text='购买' text_color='#C2B6A0'/>"
	.."	<button id='Buy2' image='1804100010' x='560' y='223' w='78' h='30' OnLButtonUp='GameMall.OnBuyItem' revmsg='true' param='2' text='购买' text_color='#C2B6A0'/>"
	.."	<button id='Buy3' image='1804100010' x='162' y='342' w='78' h='30' OnLButtonUp='GameMall.OnBuyItem' revmsg='true' param='3' text='购买' text_color='#C2B6A0'/>"
	.."	<button id='Buy4' image='1804100010' x='360' y='342' w='78' h='30' OnLButtonUp='GameMall.OnBuyItem' revmsg='true' param='4' text='购买' text_color='#C2B6A0'/>"
	.."	<button id='Buy5' image='1804100010' x='560' y='342' w='78' h='30' OnLButtonUp='GameMall.OnBuyItem' revmsg='true' param='5' text='购买' text_color='#C2B6A0'/>"
	.."	<button id='Buy6' image='1804100010' x='162' y='461' w='78' h='30' OnLButtonUp='GameMall.OnBuyItem' revmsg='true' param='6' text='购买' text_color='#C2B6A0'/>"
	.."	<button id='Buy7' image='1804100010' x='360' y='461' w='78' h='30' OnLButtonUp='GameMall.OnBuyItem' revmsg='true' param='7' text='购买' text_color='#C2B6A0'/>"
	.."	<button id='Buy8' image='1804100010' x='560' y='461' w='78' h='30' OnLButtonUp='GameMall.OnBuyItem' revmsg='true' param='8' text='购买' text_color='#C2B6A0'/>"
...
function GameMall.UIInit(_Handle)
	...
	for _Idx = 0, 2 do
		...
		if 0 ~= _WndHandle then
			GUIItemCtrlSetIconImageType(_WndHandle, 1) -- 设置显示图标为大图标
