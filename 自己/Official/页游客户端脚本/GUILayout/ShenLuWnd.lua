...
function ShenLuWnd.main()	
	...
	if _handle ~= 0 then
		...
		.."	<button id='button1' image='1803900026' x='-5' y='66' w='34' h='76' OnLButtonUp='ShenLuWnd.XueFu' revmsg='true' text='护符' text_color='#CEB362'>"
		.."	<image id='showNum1' image='1804600026' x='0' y='0' w='20' h='20' enable='false' visible='false' check_point='0' revmsg='true'/>"
		.." </button>"
		
		.."	<button id='button2' image='1803900026' x='-5' y='129' w='34' h='76' OnLButtonUp='ShenLuWnd.HuDun' revmsg='true' text='盾牌' text_color='#CEB362'>"
		.."	<image id='showNum2' image='1804600026' x='0' y='0' w='20' h='20' enable='false' visible='false' check_point='0' revmsg='true'/>"
		.." </button>"
		
		.."	<button id='button3' image='1803900026' x='-5' y='192' w='34' h='76' OnLButtonUp='ShenLuWnd.BaoShi' revmsg='true' text='宝珠' text_color='#CEB362'>"
		.."	<image id='showNum3' image='1804600026' x='0' y='0' w='20' h='20' enable='false' visible='false' check_point='0' revmsg='true'/>"
		.." </button>"
		
		.."	<button id='button4' image='1803900026' x='-5' y='257' w='34' h='76' OnLButtonUp='ShenLuWnd.HunZhu' revmsg='true' text='灵珠' text_color='#CEB362'>"
