...
--优先级, 技能ID,      使用策略,                     跑位策略,                       位置不对时,                      无法施放时,              能放但不是最佳选择时
    ...
    --烈火
    {1, 4053,   lua_use_liehuo_skill,           lua_min_distance_move,      lua_Use_Fail_Do_Abandon,    lua_Use_Fail_Do_Abandon,   lua_Use_Fail_Do_Abandon},

    --龙咆哮
    {2, 4073,   lua_use_sub_buff_skill,         lua_min_distance_move,      lua_Use_Fail_Do_Abandon,    lua_Use_Fail_Do_Abandon,   lua_Use_Fail_Do_Abandon},
        --烈地斩
    {3, 4063,   lua_use_line_attack_skill,      lua_min_distance_move,      lua_Use_Fail_Do_Abandon,    lua_Use_Fail_Do_Abandon,   lua_Use_Fail_Do_Abandon},
    --攻心斩
    {4, 4013,   lua_use_gongxin_skill,          lua_min_distance_move,      lua_Use_Fail_Do_Abandon,    lua_Use_Fail_Do_Abandon,   lua_Use_Fail_Do_Abandon},
    --半月
    {6, 4033,   lua_use_round_skill,            lua_min_distance_move,      lua_Use_Fail_Do_Abandon,    lua_Use_Fail_Do_Abandon,   lua_Use_Fail_Do_Abandon},
    --刺杀 
    {7, 4023,   lua_use_cisha_skill,            lua_special_2_grid_move,    lua_Use_Fail_Do_Abandon,    lua_Use_Fail_Do_Abandon,   lua_Use_Fail_Do_Abandon},
    {8, 4023,   lua_use_cisha_skill,            lua_special_2_grid_move,    lua_Use_Fail_Do_Abandon,       lua_Use_Fail_Do_Abandon,   lua_Use_Fail_Do_Abandon, 25},
    
    --蛮力冲锋
    {9, 4043,   lua_use_push_skill,             lua_min_distance_move,      lua_Use_Fail_Do_Abandon,    lua_Use_Fail_Do_Abandon,   lua_Use_Fail_Do_Abandon},
    --普攻
    {100, 25,   lua_use_single_attack_skill,    lua_min_distance_move,      lua_Use_Fail_Do_Move,       lua_Use_Fail_Do_Escape,    lua_Use_Fail_Do_Desperately},
}
...
tao_default_skill = {
    ...
    --逃跑
    --{3, 0,      lua_use_round_skill,            lua_escape_move,            lua_Use_Fail_Do_Abandon,     lua_Use_Fail_Do_Abandon,     lua_Use_Fail_Do_Abandon, 50},
    --通幽
    ...
    --蛊毒
    {51, 6013,   lua_use_sub_buff_skill,         lua_max_distance_move,      lua_Use_Fail_Do_Move,       lua_Use_Fail_Do_Move,     lua_Use_Fail_Do_Abandon},
    --火符
    {52, 6023,   lua_use_single_attack_skill,    lua_max_distance_move,      lua_Use_Fail_Do_Move,        lua_Use_Fail_Do_Move,     lua_Use_Fail_Do_Abandon},
    --普攻
    {100, 25,      lua_use_single_attack_skill,    lua_min_distance_move,      lua_Use_Fail_Do_Move,     lua_Use_Fail_Do_Escape,    lua_Use_Fail_Do_Desperately },
}
...
mage_default_skill = {
    ...
    --逃跑
    {1, 0,      lua_use_round_skill,            lua_escape_move,            lua_Use_Fail_Do_Abandon,     lua_Use_Fail_Do_Abandon,     lua_Use_Fail_Do_Abandon, 60},
    --盾
    {2, 5103,   lua_use_add_buff_skill,         lua_escape_move,            lua_Use_Fail_Do_Abandon,     lua_Use_Fail_Do_Abandon,     lua_Use_Fail_Do_Abandon},
    --火墙
    ...
    --引经魔轰
    {12, 5163,   lua_use_multi_attack_skill,    lua_max_distance_move,      lua_Use_Fail_Do_Abandon,        lua_Use_Fail_Do_Abandon,        lua_Use_Fail_Do_Abandon},
    --雷霆极光
    ...
    --引经魔轰
    {20, 5163,   lua_use_single_attack_skill,    lua_max_distance_move,      lua_Use_Fail_Do_Abandon,        lua_Use_Fail_Do_Abandon,        lua_Use_Fail_Do_Abandon},
    --雷电
    {21, 5033,   lua_use_single_attack_skill,    lua_max_distance_move,      lua_Use_Fail_Do_Move,        lua_Use_Fail_Do_Move,        lua_Use_Fail_Do_Abandon},
    --炎爆
    {22, 5063,   lua_use_single_attack_skill,    lua_max_distance_move,      lua_Use_Fail_Do_Move,        lua_Use_Fail_Do_Move,        lua_Use_Fail_Do_Abandon},
    --冰箭
    {23, 5043,   lua_use_single_attack_skill,    lua_max_distance_move,      lua_Use_Fail_Do_Move,        lua_Use_Fail_Do_Move,        lua_Use_Fail_Do_Abandon},
    --火球
    {24, 5003,   lua_use_single_attack_skill,    lua_max_distance_move,      lua_Use_Fail_Do_Move,        lua_Use_Fail_Do_Move,        lua_Use_Fail_Do_Abandon},
