...
function get_apprentices(player)
    local app_t = {}
    local apprentices = lualib:GetStr(player, "apprentices")
    if apprentices ~= "" then
...
function add_apprentice(player, apprentice_guid, apprentice_name)
    ...
    lualib:SetStr(player, "apprentices", app_s)
end
...
function get_master_name(player)
    local master_name = lualib:GetStr(player, "master_name")
    return master_name
end

--设置师傅名称
function set_master_name(player, master_name)
    lualib:SetStr(player, "master_name", master_name)
    lualib:Player_NotifyCustomParam(player, "master_name")
end

--获取出师时的师傅名字
function get_last_master_name(player)
    local last_master_name = lualib:GetStr(player, "last_master_name")
    return last_master_name
end

--设置出师时的师傅名字
function set_last_master_name(player, last_master_name)
    lualib:SetStr(player, "last_master_name", last_master_name)
end
...
function get_shengwang(player)
    local shengwang = lualib:GetInt(player, "shengwang")
    return shengwang
end

--设置声望
function set_shengwang(player, shengwang)
    lualib:SetInt(player, "shengwang", shengwang)
...
function process_apprentice_login(player)
    ...
    local apprentice_map_name = lualib:Name(lualib:MapGuid(apprentice))
...
function apprentice_login_send_to_master(master, apprentice, apprentice_name)
    ...
    local master_name = lualib:Name(master)
    local master_map_name = lualib:Name(lualib:MapGuid(master))
