...
function move_shop(npc, player)
	...
	msg = msg.."<@MapMoveA#蛮荒城#140#148 *01*「药店」>　　　　"
	msg = msg.."<@MapMoveA#蛮荒城#91#158 *01*「仓库」>　　　"
	msg = msg.."<@MapMoveA#蛮荒城#117#127 *01*「首饰店」>　　　\n"	
	msg = msg.."<@MapMoveA#蛮荒城#105#140 *01*「武器店」>　　　"
	msg = msg.."<@MapMoveA#蛮荒城#134#164 *01*「杂货店」>　　　"
	msg = msg.."<@MapMoveA#蛮荒城#111#183 *01*「衣服店」>　　　\n\n"
	msg = msg.."　　　　　　　　　　　　　　　　　　　　　　　　　<@main *01*「返 回」>\n "
	return msg
end
...
function move_city(npc,player)
	local msg = [[    不要相信什么凌波微步，其实这个东西很简单，只要你付#COLORCOLOR_SKYBLUE#5000金币#COLOREND#,什么问题不能解决呢？
	 ...
	 #IMAGE1902700015#<@move_yes#巫山城#331#278 *01*巫山城>           　#IMAGE1902700015#<@move_yes#龙城#255#270 *01*龙城>        　　  #IMAGE1902700015#<@move_yes#龙城#569#282 *01*神歌城>\n
	\n\n　　　　　　　　　　　　　　　　　　　　　　　　　<@main *01*返回>\n]]	
	return msg
end
