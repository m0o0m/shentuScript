...
#OFFSET<X:52,Y:0>##IMAGE1902700015##OFFSET<Y:-2>#<@enter#1 *01*《青龙阵一层》>             #OFFSET<Y:2>##IMAGE1902700015##OFFSET<Y:-2>#<@enter#2 *01*《白虎洞穴一层》>
#OFFSET<X:52,Y:5>##IMAGE1902700015##OFFSET<Y:-2>#<@enter#3 *01*《星空秘境一层》>           #OFFSET<Y:2>##IMAGE1902700015##OFFSET<Y:-2>#<@enter#4 *01*《玄武迷阵一层》>
	]]
