function main(npc, player)
	 ...
	 lualib:AddShop(npc, 16)
	
	local own_family = lualib:GetCastleOwnFamily("神歌城")	
	local msg = ""
	msg = msg.."欢迎，我们有各种各样的技能书籍。请告诉我你想买哪一种，\n"	
	if own_family ~= "" then
...
function CheckFamily(npc, player)
    ...
    if own_family == "" or own_family ~= my_family then
        ...
        msg = msg.."#OFFSET<X:0,Y:0>##IMAGE1902700033##OFFSET<X:0,Y:-2>#<@OpenShop#6 *01*「确定」>\n \n \n \n"
    else
        msg = "您是城堡的占领者，我可以给您提供打折优惠服务！\n \n \n \n"
        msg = msg.."#OFFSET<X:0,Y:0>##IMAGE1902700033##OFFSET<X:0,Y:-2>#<@OpenShop#16 *01*「确定」>\n \n \n \n"
    end
