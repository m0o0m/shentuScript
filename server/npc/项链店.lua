function main(npc, player)   
	...
	msg = msg.."#OFFSET<X:0,Y:2>##IMAGE1902700037#<@OpenShop#8 *01*「购买」   >#IMAGE1902700036#<@SellItem#1 *01*「出售」   >#IMAGE1902700035#<@ShowRepire#1 *01*「修理」   >#IMAGE1902700035#<@ShowRepireEx#1 *01*「特殊修理」>\n"
