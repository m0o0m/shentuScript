...
Guide[0][3] = "#COLORCOLOR_BROWN#   欢迎来到《神途》您将踏上神途的旅途，请问您是\n否需要我来给您介绍下我们游戏呢？#COLOREND#"
...
GuideEx =
{
	...
	["进入封魔阵"] = {"NpcTalk", true, 170, 182, 150, 40, 1904100071, true, 1, 0, false,GuideInit_Jinrufengmozhen, 29, "入场需要消耗1个#COLORCOLOR_YELLOW#镇魂笛#COLOREND#\n  #COLORCOLOR_YELLOW#镇魂笛#COLOREND#在#COLORCOLOR_YELLOW#杂货商#COLOREND#处出售\n每天可进入封魔阵#COLORCOLOR_YELLOW#3次#COLOREND#		"},
	...
	["进入试炼场"] = {"NpcTalk", true, 182, 175, 140, 53, 1904100071, true, 1, 0, false,GuideInit_Jinrushilianchang, 30, "#COLORCOLOR_YELLOW#试炼凭证#COLOREND#可以在#COLORCOLOR_YELLOW#试炼教头#COLOREND#处#COLORCOLOR_YELLOW#兑换经验#COLOREND#\n  每天可进入试炼场#COLORCOLOR_YELLOW#3次#COLOREND#，每场持续#COLORCOLOR_YELLOW#15分钟#COLOREND#"},
	...
	["悬赏任务2"] = {"NpcTalk", true, 140, 165, 130, 40, 1904100071, true, 1, 0, false,GuideInit_Xuanshangrenwu2, nil, "    查看悬赏任务\n任务有五种品质，#COLORCOLOR_YELLOW#品质越高#COLOREND#获得的#COLORCOLOR_YELLOW#经验越高#COLOREND#"},
	...
	["领取悬赏任务"] = {"NpcTalk", true, 170, 195, 130, 40, 1904100071, true, 1, 0, false,GuideInit_Lingquxuanshangrenwu, 32, "确定#COLORCOLOR_YELLOW#领取#COLOREND#悬赏任务\n拥有#COLORCOLOR_YELLOW#循环魔咒#COLOREND#可以刷新任务品质"},
	["提交悬赏任务1"] = {"NpcTalk", true, 150, 131, 130, 40, 1904100071, true, 1, 0, false, GuideInit_Tijiaoxuanshangrenwu, nil, "悬赏任务已经完成，点击这里提交任务"},
	["提交悬赏任务"] = {"NpcTalk", true, 260, 165, 130, 40, 1904100071, true, 1, 0, false,GuideInit_Tijiaoxuanshangrenwu, 33, "\n  #COLORCOLOR_YELLOW#提交#COLOREND#悬赏任务"},
	["魔咒刷新"] = {"NpcTalk", true, 311, 175, 200, 40, 1904100071, true, 1, 0, false,GuideInit_Mozhoushuaxin, 34, "发现你包裹里有#COLORCOLOR_YELLOW#15个循环魔咒#COLOREND#\n点击这里#COLORCOLOR_YELLOW#刷新#COLOREND#任务品质\n#COLORCOLOR_YELLOW#任务品质越高#COLOREND#，获得的#COLORCOLOR_YELLOW#经验也越高#COLOREND#"},
