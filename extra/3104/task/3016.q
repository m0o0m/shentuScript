...
<quests>
	<quest id="3016" name="[主线]-药材采集" type="1" suggest_level="1" visible="1" next_id="3017">
		<description>
		...
		<tracker>
			<progressing>
			<![CDATA[在附近采集5株#LINK<MAP:新手村,POSX:217,POSY:317,STR:星灵花,MOVE:1>##ITEM0#后交与药材商。]]>
			</progressing>
			<accomplishing>
		...
		<achievements>
			...
			<items>
				<item keyname="星灵花"  n="5" bind_require="2" />
			</items>
			<apply_items>
			</apply_items>
			<npcs>
		...
		<rewards exp="3150" ingot="0" bind_ingot="0" integral="0" gold="0" bind_gold="0" >
			<awards>
				...
				<award keyname="金创药(中)包"  n="1" bind_require="1" />
				<award keyname="魔法药(小)包"  n="1" bind_require="1" />
				<award keyname="魔法药(中)包"  n="1" bind_require="1" />
			</awards>
		</rewards>
		<auto>
