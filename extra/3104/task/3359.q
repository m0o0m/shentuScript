...
<quests>
	<quest id="3359" name="[主线]-修复完的神剑" type="1" suggest_level="1" visible="1" next_id="">
		<description>
		...
		<tracker>
			<progressing>
			<![CDATA[将修复好的剑交给沉船四层的#NPCLINK<STR:冒险者,NPCKEYNAME:冒险者,MOVE:1>#]]>
			</progressing>
			<accomplishing>
			<![CDATA[将修复好的剑交给沉船四层的#NPCLINK<STR:冒险者,NPCKEYNAME:冒险者,MOVE:1>#]]>
			</accomplishing>
		...
		<rewards exp="240000" ingot="0" bind_ingot="0" integral="0" gold="0" bind_gold="0" >
			<awards>
				<award keyname="疾雷项链"  n="1" bind_require="0" />
			</awards>
		</rewards>
		<auto>
