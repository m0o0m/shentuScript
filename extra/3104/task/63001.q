...
<quests>
	<quest id="63001" name="[日常]-天天扫荡" type="3" suggest_level="1" visible="1">
		<description>
		...
		<requirements>
			...
			<level enable="1" min_num="20" max_num="25" />
			<jobs>
				<job id="3" />
			</jobs>
		...
		<tracker>
			<progressing>
			<![CDATA[去扫荡180只20级及以上的怪物再回来找我吧#HUNTLEVEL0#]]>
			</progressing>
			<accomplishing>
		...
		<achievements>
			...
			<huntlevels>
				<huntlevel min_num="20"  max_num="300" n="180"/>
			</huntlevels>
			<apply_items>
			</apply_items>
			<npcs>
