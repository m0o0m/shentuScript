...
<quests>
	<quest id="4009" name="[日常]-铁棘鱼烤鱼片" type="3" suggest_level="1" visible="1">
		<description>
			我需要很多铁棘鱼，每10只铁棘鱼制作成食物后，我会给你一份，所以，多抓些铁棘鱼吧。\n
		</description>
		<dialogue>
			<brief>我需要很多铁棘鱼，每10只铁棘鱼制作成食物后，我会给你一份，所以，多抓些铁棘鱼吧。\n</brief>
			<await>至少10只铁棘鱼才可以制作成食物，你有吗？\n</await>
		...
		<tracker>
			<progressing>
			<![CDATA[前去消灭#LINK<MAP:海底1,POSX:74,POSY:144,STR:铁棘鱼,MOVE:1>#，获得#COLORCOLOR_GREENG#新鲜的铁棘鱼#COLOREND##ITEM0#]]>
			</progressing>
			<accomplishing>
