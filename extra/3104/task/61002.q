...
<quests>
	<quest id="61002" name="[日常]-天天扫荡" type="3" suggest_level="1" visible="1">
		<description>
		...
		<requirements>
			...
			<level enable="1" min_num="26" max_num="29" />
			<jobs>
				<job id="1" />
			</jobs>
		...
		<tracker>
			<progressing>
			<![CDATA[去扫荡300只25级及以上的怪物再回来找我吧#HUNTLEVEL0#]]>
			</progressing>
			<accomplishing>
		...
		<achievements>
			...
			<huntlevels>
				<huntlevel min_num="25"  max_num="300" n="300"/>
			</huntlevels>
			<apply_items>
			</apply_items>
			<npcs>
		...
		<rewards exp="155000" ingot="0" bind_ingot="0" integral="0" gold="0" bind_gold="50000" >
		</rewards>
		<auto>
