...
<quests>
	<quest id="62006" name="[日常]-天天扫荡" type="3" suggest_level="1" visible="1">
		<description>
		...
		<tracker>
			<progressing>
			<![CDATA[去扫荡350只45级以上的怪物再回来找我吧#HUNTLEVEL0#]]>
			</progressing>
			<accomplishing>
		...
		<achievements>
			...
			<huntlevels>
				<huntlevel min_num="45"  max_num="300" n="350"/>
			</huntlevels>
			<apply_items>
			</apply_items>
			<npcs>
		...
		<rewards exp="455000" ingot="0" bind_ingot="0" integral="0" gold="0" bind_gold="50000" >
		</rewards>
		<auto>
