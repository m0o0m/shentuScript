...
HintData[0] = { "1|HintDialog_0",
				"image = 1,1904100005,0,0,0,0;				edit = edit_no_use, 0, 0, 0, 0;				oninit = HINTFUNC_0_INIT;				position = 0,0;				image = 0,1904100010,0,0,0,0,0;				edit = e, 220, 100, 357, 68,, #COLORCOLOR_BROWN#   欢迎来到大型PK类网络游戏《丝路神途》您将踏上神奇之途，请问您是否需要我来给您介绍下我们游戏呢？#COLOREND#;				edit = e1, 230, 160, 100, 30, HINTFUNC_0_EDIT, #SELECT##COLORCOLOR_YELLOW#我是老手，不需要#SELECTEND#;				button = b, 370, 165, 1904100074, HINTFUNC_0_BUTTON;"}
