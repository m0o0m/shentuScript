...
function RoleReinPoint.main()
	...
	local _GUIHandle = 0
	_Parent = GUI:WndCreateWnd(_Parent,"RoleReinPoint",1805900172,634,0)
	if _Parent ~= 0 then
		GUI:WndSetSizeM(_Parent,361, 550)
	end
	
	
	_GUIHandle = GUI:ImageCreate(_Parent,"BackImg",1805900173,35,58)
	if _GUIHandle ~= 0 then
	
		GUI:WndSetParam(_GUIHandle, 0)
		GUI:WndSetSizeM(_GUIHandle,292, 473)
	end
	...
	_GUIHandle = GUI:EditCreate(_Parent,"WillGetPointNameEdit",105,180,108,16)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
		GUI:WndSetTextColorM(_GUIHandle, 4291801952)
	...
	_GUIHandle = GUI:EditCreate(_Parent,"WillGetPointEdit",213,180,80,16)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
	...
	_GUIHandle = GUI:ImageCreate(_Parent,"ConsumeBackImg",1800900026,150,206)
	if _GUIHandle ~= 0 then
	...
	_GUIHandle = GUI:EditCreate(_Parent,"ConsumeNameEdit",90,210,60,16)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
		GUI:WndSetTextColorM(_GUIHandle, 4291801952)
	...
	_GUIHandle = GUI:EditCreate(_Parent,"WanEdit",250,210,16,16)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
		GUI:WndSetTextColorM(_GUIHandle, 4291801952)
	...
	_GUIHandle = GUI:EditCreate(_Parent,"ConsumeEdit",185,210,90,16)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
	...
	_GUIHandle = GUI:ImageCreate(_Parent,"ConsumeImg",1800000052,160,213)
	if _GUIHandle ~= 0 then
	...
	_GUIHandle = GUI:ButtonCreate(_Parent,"ConvertPointBtn",1805900092,145,252)
    if _GUIHandle ~= 0 then
	...
	_GUIHandle = GUI:EditCreate(_Parent,"ConvertCountNameEdit",120,285,130,16)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
	...
	_GUIHandle = GUI:EditCreate(_Parent,"ConvertCountEdit",228,285,70,16)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
		GUI:WndSetTextColorM(_GUIHandle, 4278255360)
	...
	_GUIHandle = GUI:ImageCreate(_Parent,"PointToolBackImg1",1805900015,48,365)
	if _GUIHandle ~= 0 then
	...
	_GUIHandle = GUI:ImageCreate(_Parent,"ItemBkImg1",1805900029,62,374)
	if _GUIHandle ~= 0 then
	...
	_GUIHandle = GUI:ItemCtrlCreate(_Parent,"ItemCell1",0,67,379,40,40)
	if _GUIHandle ~= 0 then
		GUI:WndSetParam(_GUIHandle, 0)
	...
	_GUIHandle = GUI:ButtonCreate(_Parent,"PointToolBtn1",1805900096,206,387)
	if _GUIHandle ~= 0 then
	...
	_GUIHandle = GUI:EditCreate(_Parent,"PointToolNameEdit1",124,382,70,16)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
		GUI:WndSetTextColorM(_GUIHandle, 4291801952)
	...
	_GUIHandle = GUI:EditCreate(_Parent,"PointToolCountEdit1",141,404,55,16)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
	...
	_GUIHandle = GUI:ImageCreate(_Parent,"PointToolCountImg1",1800000054,124,407)
	if _GUIHandle ~= 0 then
	...
	_GUIHandle = GUI:ImageCreate(_Parent,"PointToolBackImg2",1805900015,48,447)
	if _GUIHandle ~= 0 then
	...
	_GUIHandle = GUI:ImageCreate(_Parent,"ItemBkImg2",1805900029,63,454)
	if _GUIHandle ~= 0 then
	...
	_GUIHandle = GUI:ItemCtrlCreate(_Parent,"ItemCell2",0,68,460,40,40)
	if _GUIHandle ~= 0 then
		GUI:WndSetParam(_GUIHandle, 0)
		GUI:WndSetSizeM(_GUIHandle,40, 40)
		GUI:ItemCtrlSetItemDataAutoManager(_GUIHandle, true)
	...
	_GUIHandle = GUI:ButtonCreate(_Parent,"PointToolBtn2",1805900096,206,469)
    if _GUIHandle ~= 0 then
        GUI:WndRegistScript(_GUIHandle,RDWndBaseCL_mouse_lbUp, "RoleReinPoint.buy")
        GUI:WndSetTextM(_GUIHandle,"购买并使用")
	...
	_GUIHandle = GUI:EditCreate(_Parent,"PointToolNameEdit2",124,464,70,16)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
		GUI:WndSetTextColorM(_GUIHandle, 4291801952)
	...
	_GUIHandle = GUI:EditCreate(_Parent,"PointToolCountEdit2",141,486,55,16)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
		GUI:WndSetTextColorM(_GUIHandle, 4294967040)
	...
	_GUIHandle = GUI:ImageCreate(_Parent,"PointToolCountImg2",1800000054,124,489)
	if _GUIHandle ~= 0 then
...
function RoleReinPoint.UIInit(_Handle)
	...
	GUI:WndSetSizeM(_Handle, 361, 550)
	local level = 0 
