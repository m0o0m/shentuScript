OnloginReward = {}
local ui = "<form default_parent ='RewardHall'> <dialog OnInit='OnloginReward.UIInit' id='OnloginReward' image='1805600004' esc_close='false' drag='false'  x='186' y='58' w='622' h='484' revmsg='true'>"
	...
	.."	<image id='Itembackimg1' image='1800000384' x='238' y='333' w='58' h='58' revmsg='false' enable='false'/>"
	.."	<image id='Itembackimg2' image='1800000384' x='315' y='333' w='58' h='58' revmsg='false' enable='false'/>"
	.."	<image id='Itembackimg3' image='1800000384' x='393' y='333' w='58' h='58' revmsg='false' enable='false'/>"
	.."	<image id='Itembackimg4' image='1800000384' x='469' y='333' w='58' h='58' revmsg='false' enable='false'/>"
	.."	<image id='Itembackimg5' image='1800000384' x='546' y='333' w='58' h='58' revmsg='false' enable='false'/>"
	.."	<itemctrl id='item1' x='242' y='336' w='58' h='58' rbtn_use='true' use_back='0' enable='true' revmsg='true'/>"
	.."	<itemctrl id='item2' x='319' y='337' w='58' h='58' rbtn_use='true' use_back='0' enable='true' revmsg='true'/>"
	.."	<itemctrl id='item3' x='397' y='337' w='58' h='58' rbtn_use='true' use_back='0' enable='true' revmsg='true'/>"
	.."	<itemctrl id='item4' x='473' y='337' w='58' h='58' rbtn_use='true' use_back='0' enable='true' revmsg='true'/>"
	.."	<itemctrl id='item5' x='550' y='337' w='58' h='58' rbtn_use='true' use_back='0' enable='true' revmsg='true'/>"
	...
	.."	<image id='image_2' image='1891410064' x='106' y='54' w='64' h='64' check_point='0' revmsg='false' enable='false'/>"
	.."	<image id='image_3' image='1990040423' x='195' y='56' w='60' h='60' check_point='0' revmsg='false' enable='false'/>"
	...
	.."	<image id='TextImg1' image='1805600083' x='20' y='180' w='200' h='56' revmsg='true'/>"
	.."	<image id='TextImg2' image='1805600073' x='13' y='128' w='80' h='25' revmsg='true'/>"
	.."	<image id='TextImg3' image='1805600074' x='100' y='128' w='80' h='25' revmsg='true'/>"
	.."	<image id='TextImg4' image='1805600075' x='186' y='128' w='80' h='25' revmsg='true'/>"
	.."	<image id='TextImg5' image='1805600076' x='274' y='128' w='80' h='25' revmsg='true'/>"
	.."	<image id='TextImg6' image='1805600077' x='356' y='128' w='80' h='25' revmsg='true'/>"
	.."	<image id='TextImg7' image='1805600078' x='446' y='128' w='80' h='25' revmsg='true'/>"
	.."	<image id='TextImg8' image='1805600079' x='531' y='128' w='80' h='25' revmsg='true'/>"
	.." </dialog>"
	.."</form>"
...
function OnloginReward.UIInit(_Handle)
	...
	for i = 1 , 7 do
		...
		GUI:WndSetTextArrangeType(handle,0,-44,4,0);
		GUI:ButtonSetStateTextColor(handle,0,MakeARGB(255, 193, 149, 76))
		GUI:ButtonSetStateTextColor(handle,2,MakeARGB(255, 254, 203, 0))
	end
...
function OnloginReward.showInfo(_Ret)
	...
	local _GUIHandle = GUI:WndFindChildM(OnloginReward.WndHandle, "button_day".._Ret[8])	
...
function OnloginReward.selectbutton(_Handle)
	...
	local _GUIHandle = 0
	for i = 1, 7 do
		_GUIHandle = GUI:WndFindChildM(OnloginReward.WndHandle, "button_day"..i)
		if i == param then
			GUI:ButtonSetIsActivePageBtn(_GUIHandle, true)
		else
			GUI:ButtonSetIsActivePageBtn(_GUIHandle, false)
		end
		_Handle = GUI:WndFindChildM(OnloginReward.WndHandle, "imageGet_"..i)
	...
	for i = 1, 5 do
		_GUIHandle = GUI:WndFindChildM(OnloginReward.WndHandle, "item"..i)
	...
	if OnloginReward.item_y[OnloginReward.index] == 1 or OnloginReward.index > OnloginReward.info[8]  then
		local _GUIHandle = GUI:WndFindChildM(OnloginReward.WndHandle,"button")	
		if _GUIHandle ~= 0 then
...
function OnloginReward.change(index,b)
	...
	local _Handle = GUI:WndFindChildM(OnloginReward.WndHandle, "imageGet_"..a)
	if _Handle ~= 0 then
		GUI:WndSetVisible(_Handle,true)
	end	
