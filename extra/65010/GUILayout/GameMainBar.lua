...
function GameMainBar.main()
	...
	_GUIHandle = GUI:ButtonCreate(_Parent,"Auto",1800500238,521,-27)
	if _GUIHandle ~= 0 then
		GUI:WndRegistScript(_GUIHandle,1003, "GameMainBar.OnAuto")
		GUI:WndSetHint(_GUIHandle,"挂机(Z)")
		GUI:WndSetParam(_GUIHandle, 0)
		GUI:WndSetSizeM(_GUIHandle,48, 44)
	end
	
	_GUIHandle = GUI:ImageCreate(_Parent,"Autoimage",1801500181,522,8)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
    ...
    _GUIHandle = GUI:ButtonCreate(_Parent,"Achievement",1800500254,570,-27)
    if _GUIHandle ~= 0 then
        GUI:WndRegistScript(_GUIHandle,RDWndBaseCL_mouse_lbUp, "GameMainBar.OnAchievementBtn")
        GUI:WndSetHint(_GUIHandle,"成就(I)")
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetSizeM(_GUIHandle,40, 40)
    end
	
    _GUIHandle = GUI:ImageCreate(_Parent, "AchieveNum2", 0, 590, -35)
	
    _GUIHandle = GUI:ImageCreate(_Parent,"Achievementimage",1801500177,571,8)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetSizeM(_GUIHandle,46, 20)
    ...
    _GUIHandle = GUI:ButtonCreate(_Parent,"Guild",1800500286,472,-27)
    if _GUIHandle ~= 0 then
    ...
    _GUIHandle = GUI:ImageCreate(_Parent,"Familyimage",1801500187,473,8)
    if _GUIHandle ~= 0 then
        GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetSizeM(_GUIHandle,46, 20)
	...
	_GUIHandle = GUI:ImageCreate(_Parent, "redPacketBtnMagic", 3020300100, -420, -170)
	if _GUIHandle ~= 0 then 
...
function GameMainBar.UIInit(_Parent)
	...
	CL:HotKeyRegister("Z", "自动挂机", "GameMainBar.OnAuto"); --注册挂机热键Z
