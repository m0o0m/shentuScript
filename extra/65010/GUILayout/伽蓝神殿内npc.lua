...
local ui = "<form> <dialog OnInit='MagicPagodaInWnd.UIInit' id='MagicPagodaInWnd' image='1806100012' x='778' y='215' w='384' h='505' esc_close='true' drag='true' revmsg='true'>"
	...
	.." <image id='ItemBkImg1' image='1806000059' x='70' y='206' w='48' h='48' />"
	.." <image id='ItemBkImg2' image='1806000059' x='70' y='295' w='48' h='48' />"
	.."	<itemctrl id='item1' x='70' y='206' w='48' h='48' rbtn_use='true' use_back='0' init_item='镇魔令牌' enable='true' revmsg='true'/>"
	.."	<itemctrl id='item2' x='70' y='295' w='48' h='48' rbtn_use='true' use_back='0' init_item='羽毛' enable='true' revmsg='true'/>"
...
function MagicPagodaInWnd.main()
	if GetWindow(0, "MagicPagodaInWnd") ~= 0 then 
		GUI:WndClose(GetWindow(0, "MagicPagodaInWnd"))
	else
		GenFormByString(ui) 
	end
	--GenFormByString(ui) 
...
function MagicPagodaInWnd.closeWnd()     --关闭按钮
	local hand = GetWindow(0,"MagicPagodaInWnd")
	if hand ~= 0 then
		GUI:WndClose(hand)
	end
end
...
function MagicPagodaInWnd.msg(str)
	local hand = GetWindow(0,"MagicPagodaInWnd,info6")
	if hand ~= 0 then 
