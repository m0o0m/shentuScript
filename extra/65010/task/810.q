...
<quests>
	<quest id="810" name="#COLORCOLOR_YELLOW#[金币] #COLORCOLOR_ORANGE#矿物的抢夺#COLORCOLOR_RED#(可接)" type="2" suggest_level="1" visible="1">
		<description>
		...
		<tracker>
			<progressing>
			<![CDATA[找 矿主 #NPCLINK<STR:(接受任务),NPCKEYNAME:巫山城矿主,MOVE:1>#]]>
			</progressing>
			<accomplishing>
