...
<quests>
	<quest id="1004" name="#COLORCOLOR_YELLOW#[经验、功勋] #COLORCOLOR_ORANGE#功勋除魔" type="2" suggest_level="1" visible="1">
		<script name="除魔任务" />
		<description>
		...
		<tracker>
			<progressing>
			<![CDATA[#LINK<MAP:赤月神殿二层,POSX:49,POSY:69,STR:杀死蜘蛛洞任意怪物,MOVE:1># #MONSTERGROUP0#]]>
			</progressing>
			<accomplishing>
