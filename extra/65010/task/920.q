...
<quests>
	<quest id="920" name="#COLORCOLOR_YELLOW#[经验、功勋] #COLORCOLOR_ORANGE#功勋除魔" type="2" suggest_level="1" visible="1" next_id="">
		<script name="除魔任务" />
		<description>
		...
		<tracker>
			<progressing>
			<![CDATA[#LINK<MAP:沃玛寺庙一层,POSX:94,POSY:125,STR:击杀天荒任意怪物,MOVE:1># #MONSTERGROUP0#]]>
			</progressing>
			<accomplishing>
