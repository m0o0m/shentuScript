...
<quests>
	<quest id="1154" name="#COLORCOLOR_YELLOW#[经验、功勋] #COLORCOLOR_ORANGE#功勋除魔" type="2" suggest_level="1" visible="1">
		<script name="除魔任务" />
		<description>
		...
		<tracker>
			<progressing>
			<![CDATA[#LINK<MAP:尸魔洞一层,POSX:62,POSY:109,STR:击杀永夜之地任意怪物,MOVE:1># #MONSTERGROUP0#]]>
			</progressing>
			<accomplishing>
