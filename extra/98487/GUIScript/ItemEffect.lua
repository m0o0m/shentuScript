...
function BeginFlower(_ImageIDStr, _Param)
	...
	if _ImageID ~= 0 then
		return UI:Lua_BeginFlower(_ImageID,_Param)
	else
		return false
	end
end
...
function Play_yanhua()
	...
	local _X = LuaRet[1] / 2
	local _Y = LuaRet[2] / 2 - 80
	local _ParticleType = ScreenParticleType_NoMove
	local _PlayCtrlType = PlayCtrlType_StopLast
	local _LifeTime = 30000
	local _Speed = 100
	BeginFlower("1600100000","".._ParticleType.."#".._PlayCtrlType.."#".._X.."#".._Y.."#".._LifeTime.."#".._Speed)
end

function Play_yanhua2()
        UI:Lua_GetScreenSize()
	local _X = LuaRet[1] / 2
	local _Y = LuaRet[2] / 2 - 80
	local _ParticleType = ScreenParticleType_NoMove
	local _PlayCtrlType = PlayCtrlType_StopLast
	local _LifeTime = 3000
	local _Speed = 150
	BeginFlower("1600100000","".._ParticleType.."#".._PlayCtrlType.."#".._X.."#".._Y.."#".._LifeTime.."#".._Speed)
end
...
function choujiang(x, y)
	...
	if UI:Lua_GetWindow("NpcTalk") then
...
function PlaySound(SoundName, SoundType)
	...
	return UI:Lua_PlaySound(SoundName, SoundType)
end
