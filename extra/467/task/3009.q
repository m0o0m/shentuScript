...
<quests>
	<quest id="3009" name="[主线]-勇气的试炼" type="1" suggest_level="1" visible="1" next_id="3010">
		...
		<requirements>
			...
			<acquire_items>
				<acquire_item keyname="乌木剑"  n="1" bind_require="1" />
			</acquire_items>
		</requirements>
		<tracker>
			<progressing>
			<![CDATA[在村子附近击败#LINK<MAP:新手村,POSX:269,POSY:321,STR:鹿,MOVE:1>##MONSTERGROUP0#获取1块肉#ITEMGROUP0#]]>
			</progressing>
			<accomplishing>
