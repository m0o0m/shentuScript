...
ROLE_PROP32_MAX_INNER_FORCE			 =i;i=i+1--///最大内功值
...
--内功------------------------------------------
local i = 1
INNER_UPGRADEEXP                         =i;i=i+1
INNER_INNERFORCEVALUE                 =i;i=i+1
INNER_INNERFORCEREC                     =i;i=i+1
INNER_INTERVAL			                  =i;i=i+1
INNER_DERATEPCT		                       =i;i=i+1
