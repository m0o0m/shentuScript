...
local ui = "<form> <dialog OnInit='DemonWnd.UIInit' id='DemonWnd' image='1806100012' x='26' y='6' w='384' h='505' esc_close='true' center='true' drag='true' revmsg='true'>"
	.."	<image id='lineImage1' image='1806100013' x='43' y='165' w='299' h='2' check_point='0' revmsg='true'/>"
	.."	<image id='lineImage2' image='1806100013' x='42' y='399' w='299' h='2' check_point='0' revmsg='true'/>"
	.."	<image id='tittle' image='1805500041' x='164' y='11' w='68' h='19' check_point='0' revmsg='true' enable='false'/>"
	...
	.."	<richedit id='enterMap' x='140' y='418' w='150' h='20' text_color='#00FF00' text='#SELECT#进入禁魔神殿#SELECTEND#' OnLButtonUp='DemonWnd.EnterMap' revmsg='true' font='system'/>"
	...
	.."	<edit id='t9' x='82' y='81' w='258' h='20' revmsg='true' text_color='#E4C19F' text='活动将于每周二， 四，六开放' font='system'/>" --开服两周后，
	...
	.."	<edit id='TestWndChild_2' x='146' y='141' w='73' h='20' revmsg='true' text_color='#00FF00' text='80级' font='system'/>"
	.."	<edit id='t22' x='82' y='141' w='64' h='20' revmsg='true' text_color='#E4C19F' text='参与等级：' font='system'/>"
	.." </dialog>"
	.."</form>" 
