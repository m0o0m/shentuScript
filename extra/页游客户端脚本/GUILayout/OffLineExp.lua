OffLineExp ={}
local ui = "<form default_parent ='Reward_win'> <dialog OnInit='OffLineExp.UIInit' id='OffLineExp' image='1805600005' x='186' y='58' w='622' h='484' revmsg='true'>"
	...
	--.."	<edit id='time_edit' x='117' y='130' w='30' h='20' revmsg='true' enable='false' text_color='#2ABC03' text='0' font='system'/>"
	...
	--.."	<edit id='exp1' x='194' y='242' w='66' h='27' canedit='false' revmsg='true' enable='false' text_color='#DEBA26' text='0' font='system'/>"
	...
	--.."	<edit id='exp2' x='194' y='331' w='66' h='27' canedit='false' revmsg='true' enable='false' text_color='#DEBA26' text='0' font='system'/>"
	...
	.."	<image id='ybImage1' image='1800000054' x='348' y='339' w='16' h='14' check_point='0' revmsg='true' enable='false'/>"
	...
	--.."	<edit id='exp3' x='193' y='426' w='66' h='27' canedit='false' revmsg='true' enable='false' text_color='#DEBA26' text='0' font='system'/>"
	...
	.."	<image id='ybImage2' image='1800000054' x='348' y='432' w='16' h='14' check_point='0' revmsg='true' enable='false'/>"
...
function OffLineExp.Info(dat,index)
	...
	if hour > 0 then
		...
		--[[local _Handle = GUIWndFindChildM(OffLineExp.WndHandle, "time_edit")
		GUIEditSetTextM(_Handle,""..hour)	--]]
		for i=1,#num_tab do
...
--[[	handle = GUIWndFindChildM(OffLineExp.WndHandle, "time_edit")
	if handle ~= 0 then
		GUIEditSetTextM(handle,"0")	
	end--]]
	...
	handle = GetWindow(nil,"Reward_win,image4")
	if handle ~= 0 then
		GUIWndSetVisible(handle, false) 
	end
	for i = 1, 3 do
...
--[[	for i = 2, 3 do
		handle = GetWindow(OffLineExp.WndHandle, "yb"..i)
		if handle ~= 0 then
			GUIEditSetTextM(handle,"0")	
		end
	end--]]
