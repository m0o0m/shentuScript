BuyWnd ={}
local ui = "<form> <dialog OnInit='BuyWnd.UIInit' id='BuyWnd' image='1804600001' x='159' y='251' w='256' h='191' revmsg='true'>"
	.."	<itemctrl id='TestWndChild_12'  init_item='鹤嘴锄' x='25' y='79' w='48' h='48' use_back='1806000059' rbtn_use='true' enable='true' revmsg='true'/>"
	...
	.."	<edit id='TestWndChild_16' x='115' y='6' w='91' h='23' revmsg='true' text_color='#C2B6A0' text='系统' font='system'/>"
...
function BuyWnd.main()
	if GetWindow("", "BuyWnd") ~= 0 then 
		GUIWndClose(GetWindow("", "BuyWnd"))
	else
		GenFormByString(ui) 
	end
end
