xldb_NPCShow ={}
local ui = "<form> <dialog OnInit='xldb_NPCShow.UIInit' id='xldb_NPCShow' image='1806100012' x='298' y='46' w='384' h='505' esc_close='true' center='true' drag='true' revmsg='true'>"
	...
	--.."	<edit id='tittle' x='155' y='10' w='127' h='22' revmsg='true' text_color='#FCFF00' text='寻龙夺宝' font='SIMLI18'/>"
	.."	<image id='tittle' image='1805500042' x='163' y='13' w='127' h='22' revmsg='false' enable='false' font='system'/>"
...
function xldb_NPCShow:closeWnd()     --关闭按钮
	local hand = GetWindow(0,"xldb_NPCShow")
	if hand ~= 0 then
		GUI:WndClose(hand)
	end
end
...
function xldb_NPCShow.msg(str)
	...
	if hand ~= 0 then 
		window_msg_up(hand,str,-47,-25,60,MakeARGB(255, 255, 0, 0),1.5)
	end
end