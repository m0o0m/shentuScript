...
<quests>
	<quest id="40002" name="[悬赏]-讨伐僵尸洞" type="1" suggest_level="1" visible="0">
		<description>
...
#IMAGE1902100024#
     击败10只#COLORCOLOR_GREENG##LINK<MAP:废矿入口,POSX:61,POSY:318,STR:僵尸洞,MOVE:1>##COLOREND#的#COLORCOLOR_GREENG##LINK<MAP:废矿入口,POSX:61,POSY:318,STR:僵尸,MOVE:1>##COLOREND#后与#COLORCOLOR_GREENG##NPCLINK<STR:天机老人,NPCID:25002,MOVE:1>##COLOREND#对话
...
#IMAGE1902100025#
   ...
   奖励经验：角色等级越高获得越多]]>
		...
		<tracker>
			<progressing>
			<![CDATA[去#COLORCOLOR_GREENG##LINK<MAP:废矿入口,POSX:20,POSY:52,STR:僵尸洞,MOVE:1>##COLOREND#击败10只#COLORCOLOR_GREENG##LINK<MAP:废矿入口,POSX:20,POSY:52,STR:僵尸,MOVE:1>##COLOREND##MONSTERGROUP0#后回来找我]]>
			</progressing>
			<accomplishing>
