...
<quests>
	<quest id="40009" name="[悬赏]-讨伐骷髅洞" type="1" suggest_level="1" visible="0">
		<description>
...
#IMAGE1902100025#
   ...
   奖励经验：角色等级越高获得越多]]>
		...
		<tracker>
			<progressing>
			<![CDATA[去#COLORCOLOR_GREENG##LINK<MAP:兽人古墓一层,POSX:45,POSY:42,STR:骷髅洞,MOVE:1>##COLOREND#击败10只任意#COLORCOLOR_GREENG##LINK<MAP:兽人古墓一层,POSX:45,POSY:42,STR:怪物,MOVE:1>##COLOREND##MONSTERGROUP0#后回来找我]]>
			</progressing>
			<accomplishing>
