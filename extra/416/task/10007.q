...
<quests>
	<quest id="10007" name="[悬赏]-讨伐封魔殿" type="1" suggest_level="1" visible="0">
		<description>
...
#IMAGE1902100025#
   ...
   奖励经验：角色等级越高获得越多]]>
		...
		<tracker>
			<progressing>
			<![CDATA[去#COLORCOLOR_GREENG##LINK<MAP:疾风殿,POSX:52,POSY:58,STR:封魔殿,MOVE:1>##COLOREND#击败20只#COLORCOLOR_GREENG##LINK<MAP:疾风殿,POSX:52,POSY:58,STR:黑野猪,MOVE:1>##COLOREND##MONSTERGROUP0#后回来找我]]>
			</progressing>
			<accomplishing>
