...
<quests>
	<quest id="20003" name="[悬赏]-讨伐猪洞" type="1" suggest_level="1" visible="0">
		<description>
...
#IMAGE1902100025#
   ...
   奖励经验：角色等级越高获得越多]]>
		...
		<tracker>
			<progressing>
			<![CDATA[去#COLORCOLOR_GREENG##LINK<MAP:石窟一层,POSX:118,POSY:156,STR:猪洞,MOVE:1>##COLOREND#击败10只#COLORCOLOR_GREENG##LINK<MAP:石窟一层,POSX:118,POSY:156,STR:红野猪,MOVE:1>##COLOREND##MONSTERGROUP0#后回来找我]]>
			</progressing>
			<accomplishing>
