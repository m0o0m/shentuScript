...
function FashionEquiment.main()
	...
	local _GUIHandle = 0
	_GUIHandle = GUI:WndCreateWnd(_Parent,"FashionWnd",1930200125,0,-2)
	...
	_GUIHandle = GUI:CheckBoxCreate(_Parent,"ShowFashion",1900112013,"显示时装",53,290)
	if _GUIHandle ~= 0 then
	...
	_GUIHandle = GUI:ItemCtrlCreate(_Parent,"FashionEquiment",-1,12,18,164,216)
	if _GUIHandle ~= 0 then
...
function FashionEquiment.UIInit(_Handle)
	...
	if _FashionEquimentHandle ~= 0 then
		...
		GUI:ItemCtrlSetBigIconOffset(_FashionEquimentHandle, 114, 123)
