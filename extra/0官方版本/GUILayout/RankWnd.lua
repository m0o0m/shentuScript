...
function RankWnd.main()
    ...
    _GUIHandle = GUI:ImageCreate(_Parent,"BackImg",1930300018,0,0)
    ...
    _GUIHandle = GUI:ImageCreate(_Parent,"LevelBkImg",1930300021,130,73)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
    ...
    _GUIHandle = GUI:ImageCreate(_Parent,"BeautyBkImg",1930300024,130,73)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetSizeM(_GUIHandle,401, 309)
    end
    ...
    _GUIHandle = GUI:ListBoxCreate(_Parent,"ListCtrl",129,102,402,280)
    if _GUIHandle ~= 0 then
		...
		GUI:ListBoxSetColumnPos(_GUIHandle, 3, 185)
		GUI:ListBoxSetColumnPos(_GUIHandle, 4, 241)
		GUI:ListBoxSetColumnPos(_GUIHandle, 5, 280)
    ...
    _GUIHandle = GUI:ButtonCreate(_Parent,"CloseBtn",1930001002,539,5)
    if _GUIHandle ~= 0 then
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"MyRankEdit",166,45,237,15)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
    ...
    _GUIHandle = GUI:ButtonCreate(_Parent,"LevelBtn",1900600001,28,89)
    if _GUIHandle ~= 0 then
    ...
    _GUIHandle = GUI:ButtonCreate(_Parent,"TotalLevelBtn",1900600029,38,109)
    if _GUIHandle ~= 0 then
    ...
    _GUIHandle = GUI:ButtonCreate(_Parent,"WarLevelBtn",1900600033,38,128)
    if _GUIHandle ~= 0 then
    ...
    _GUIHandle = GUI:ButtonCreate(_Parent,"MagLevelBtn",1900600037,38,147)
    if _GUIHandle ~= 0 then
    ...
    _GUIHandle = GUI:ButtonCreate(_Parent,"TaoLevelBtn",1900600041,38,166)
    if _GUIHandle ~= 0 then
    ...
    _GUIHandle = GUI:ButtonCreate(_Parent,"BeautyBtn",1900600021,28,89)
    if _GUIHandle ~= 0 then
    ...
    _GUIHandle = GUI:ButtonCreate(_Parent,"TotalBeautyBtn",1900600029,28,89)
    if _GUIHandle ~= 0 then
    ...
    _GUIHandle = GUI:ButtonCreate(_Parent,"MaleBeautyBtn",1900600069,28,89)
    if _GUIHandle ~= 0 then
    ...
    _GUIHandle = GUI:ButtonCreate(_Parent,"FemaleBeautyBtn",1900600073,28,89)
    if _GUIHandle ~= 0 then
...
function RankWnd.ButtonExpand(group_name)
	...
	for i = 1, 2 do
		...
		if _GUIHandle ~= 0 then
			GUI:WndSetPosM(_GUIHandle, 28, y)
			y = y + 19
...
function RankWnd.getRankList()
	...
	for i = 1, #RankWnd.list[RankWnd.SortType] do
		RankWnd.list[RankWnd.SortType][i] = RankWnd.list[RankWnd.SortType][i]
	end
	RankWnd.UpdateUI()
end
