--
-- Author: miyezng
-- Date:   2016-09-23 13:22:56
-- Last Modified by:   miyezng
-- Last Modified time: 2016-10-08 14:39:05
--
--装备品质属性值
...
function tipItemsLayoutTitle(ihandle, ehandle, equip)
    ...
    ret = ret..tipText(name, color, "system")
    --精炼等级--
...
function tipItemsLayoutSuit(ihandle, ehandle, equip)
    ...
    if UI:Lua_GetItemTemplatePropByHandle(ihandle, ITEM_PROP_SUIT) and LuaRet ~= 0 then
        ...
        local suit_prop_size =
        {
            ...
            {SUIT_PROP_ATTSIZE11,0},
            {SUIT_PROP_ATTSIZE12,0},
            {SUIT_PROP_ATTSIZE13,0},
            {SUIT_PROP_ATTSIZE14,0},
            {SUIT_PROP_ATTSIZE15,0},
            {SUIT_PROP_ATTSIZE16,0},
            {SUIT_PROP_ATTSIZE17,0},
            {SUIT_PROP_ATTSIZE18,0},
            {SUIT_PROP_ATTSIZE19,0},
            {SUIT_PROP_ATTSIZE20,0},
            {SUIT_PROP_ATTSIZE21,0},
            {SUIT_PROP_ATTSIZE22,0},
            {SUIT_PROP_ATTSIZE23,0},
            {SUIT_PROP_ATTSIZE24,0},
            {SUIT_PROP_ATTSIZE25,0}
        }
        ...
        local suit_prop_value =
        {
            ...
            {SUIT_PROP_ATTVALUE11,0},
            {SUIT_PROP_ATTVALUE12,0},
            {SUIT_PROP_ATTVALUE13,0},
            {SUIT_PROP_ATTVALUE14,0},
            {SUIT_PROP_ATTVALUE15,0},
            {SUIT_PROP_ATTVALUE16,0},
            {SUIT_PROP_ATTVALUE17,0},
            {SUIT_PROP_ATTVALUE18,0},
            {SUIT_PROP_ATTVALUE19,0},
            {SUIT_PROP_ATTVALUE20,0},
            {SUIT_PROP_ATTVALUE21,0},
            {SUIT_PROP_ATTVALUE22,0},
            {SUIT_PROP_ATTVALUE23,0},
            {SUIT_PROP_ATTVALUE24,0},
            {SUIT_PROP_ATTVALUE25,0}
        }
