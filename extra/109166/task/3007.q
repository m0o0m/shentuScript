...
<quests>
	<quest id="3007" name="[主线]-凶猛的家鸡" type="1" suggest_level="1" visible="1" next_id="3008">
		...
		<tracker>
			<progressing>
			<![CDATA[在村子附近击败5只#LINK<MAP:新手村,POSX:263,POSY:298,STR:鸡,MOVE:1>##MONSTERGROUP0#后再来找我]]>
			</progressing>
			<accomplishing>
		...
		<rewards exp="300" ingot="111" bind_ingot="1111" integral="1111" gold="1111" bind_gold="111" >
			<awards>
				<award keyname="木剑"  n="5" bind_require="0" />
			</awards>
		</rewards>
		<auto>
