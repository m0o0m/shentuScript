...
function ShenLu_buy4.main()
    ...
    _GUIHandle = GUI:ImageCreate(_Parent,"yuanbao1",1800000054,86,119)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"item1_price",105,118,64,17)
    if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
    end
    ...
    _GUIHandle = GUI:ImageCreate(_Parent,"yuanbao2",1800000054,88,209)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetSizeM(_GUIHandle,16, 14)
        GUI:ImageSetParam(_GUIHandle, 0)
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"item2_price",106,207,64,17)
    if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
        GUI:WndSetParam(_GUIHandle, 0)
    end
    ...
    _GUIHandle = GUI:ImageCreate(_Parent,"TestWndChild_22",1800000054,87,304)
    if _GUIHandle ~= 0 then
        GUI:WndSetParam(_GUIHandle, 0)
        GUI:WndSetSizeM(_GUIHandle,16, 14)
        GUI:ImageSetParam(_GUIHandle, 0)
...
function ShenLu_buy4.msgbox()
	luaMsgBox.new("元宝", "很抱歉，您的元宝不足", {"前往充值", "取消"}, {"ShenLu_buy4.chongz", "ShenLu_buy4.out"}, "")
end
