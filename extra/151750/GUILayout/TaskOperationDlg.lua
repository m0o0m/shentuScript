...
function TaskOperationDlg.main()
	...
	local _GUIHandle = 0
	_GUIHandle = GUI:ImageCreate(_Parent,"BkImg",1850100032, -200, 50)
	if _GUIHandle ~= 0 then
		GUI:WndSetSizeM(_GUIHandle,784, 321)
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetCanRevMsg(_GUIHandle, false)
	end
	_GUIHandle = GUI:ImageCreate(_Parent,"title",1850100030,116 - 261 + 16,63 - 20)
	if _GUIHandle ~= 0 then
	...
	_GUIHandle = GUI:ButtonCreate(_Parent,"closeBtn",1850000385,450,88)
	if _GUIHandle ~= 0 then
	...
	_GUIHandle = GUI:EditCreate(_Parent,"missionName", 108 ,71,200, 90)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
	...
	_GUIHandle = GUI:RichEditCreate(_Parent,"missionDescription", 0 ,150, 400, 230)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
		GUI:RichEditSetEditEnable(_GUIHandle, false)
	...
	_GUIHandle = GUI:EditCreate(expWnd_Parent,"rewardName",60,20,200,20)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
	...
	_GUIHandle = GUI:EditCreate(ingotWnd_Parent,"rewardName",60,20,200,20)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
		GUI:WndSetTextColorM(_GUIHandle, 4290936121)
	...
	_GUIHandle = GUI:EditCreate(bind_ingotWnd_Parent,"rewardName",60,20,200,20)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
		GUI:WndSetTextColorM(_GUIHandle, 4290936121)
	...
	_GUIHandle = GUI:EditCreate(integralWnd_Parent,"rewardName",60,20,200,20)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
		GUI:WndSetTextColorM(_GUIHandle, 4290936121)
	...
	_GUIHandle = GUI:EditCreate(goldWnd_Parent,"rewardName",60,20,200,20)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
		GUI:WndSetTextColorM(_GUIHandle, 4290936121)
	...
	_GUIHandle = GUI:EditCreate(bind_goldWnd_Parent,"rewardName",60,20,200,20)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
		GUI:WndSetTextColorM(_GUIHandle, 4290936121)
	...
	_GUIHandle = GUI:ImageCreate(_Parent, "ItemBkImg1", 1850500016, 49,290)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle,false)
	end
	
	_GUIHandle = GUI:ItemCtrlCreate(_Parent,"item1",0,50,290,64,64)
	if _GUIHandle ~= 0 then
		GUI:WndSetVisible(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
	...
	_GUIHandle = GUI:ImageCreate(_Parent, "ItemBkImg2", 1850500016, 114,290)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle,false)
	end
	
	_GUIHandle = GUI:ItemCtrlCreate(_Parent,"item2",0,115,290,64,64)
	if _GUIHandle ~= 0 then
		GUI:WndSetVisible(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
		GUI:ItemCtrlSetRBtnUse(_GUIHandle, true)
	...
	_GUIHandle = GUI:ImageCreate(_Parent, "ItemBkImg3", 1850500016, 179,290)
	if _GUIHandle ~= 0 then
		GUI:WndSetEnableM(_GUIHandle,false)
	end
	
	_GUIHandle = GUI:ItemCtrlCreate(_Parent,"item3",0,180,290,64,64)
	if _GUIHandle ~= 0 then
		GUI:WndSetVisible(_GUIHandle, false)
		GUI:WndSetParam(_GUIHandle, 0)
		GUI:ItemCtrlSetRBtnUse(_GUIHandle, true)
	...
	_GUIHandle = GUI:ButtonCreate(_Parent,"confirmBtn",1850000307, 300, 290)
	if _GUIHandle ~= 0 then
		GUI:WndRegistScript(_GUIHandle,1003, "TaskOperationDlg.confirmBtn_LC")
		GUI:WndSetParam(_GUIHandle, 0)
		--I:WndSetSizeM(_GUIHandle,88, 31)
...
function TaskOperationDlg.getQuest()		
	...
	local titleImg = GetWindow(0,"TaskOperationDlg,title")
	local txt = ""
	...
	if CL:TaskQueryAccepted(TaskOperationDlg.mID) then
		...
		if TaskOperationDlg.accept == 1 or TaskOperationDlg.complete == 1 then  
			...
			GUI:WndSetImageID(titleImg, 1850100029)
			if GUI:WndGetPosM(titleImg) then
				GUI:WndSetPosM(titleImg, LuaRet[1] + 25, LuaRet[2] - 6)
			end
		end
