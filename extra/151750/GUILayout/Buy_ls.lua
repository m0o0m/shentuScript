...
function Buy_ls.main()
    ...
    _GUIHandle = GUI:ButtonCreate(_Parent,"close",1850000423,251,7)
    if _GUIHandle ~= 0 then
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"item1_name",96,95,0,0)
    if _GUIHandle ~= 0 then
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"item1_price",125,122,0,0)
    if _GUIHandle ~= 0 then
    end
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"item2_name",96,205,0,0)
    if _GUIHandle ~= 0 then
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"item2_price",125,235,0,0)
    if _GUIHandle ~= 0 then
    end
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"BindYuanBao",72,422,0,0)
    if _GUIHandle ~= 0 then
        GUI:EditSetFontCenter(_GUIHandle)
    end
    
    _GUIHandle = GUI:EditCreate(_Parent,"YuanBao",72,456,0,0)
    if _GUIHandle ~= 0 then
        GUI:EditSetFontCenter(_GUIHandle)
    end
