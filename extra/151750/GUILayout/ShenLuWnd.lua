...
function ShenLuWnd.main()
    ...
    _Parent = GUI:WndCreateWnd(_Parent,"ShenLuWnd",1803900035,0,0)
    if _Parent ~= 0 then
    end
    ...
    _GUIHandle = GUI:ButtonCreate(_Parent,"Close",1850000385,_DeviceSizeX - 40, 0)
    if _GUIHandle ~= 0 then
    	--GUI:WndRegistScript(_GUIHandle,RDWndBaseCL_mouse_lbUp, "ShenLuWnd.closeWnd")
    end
    ...
    _GUIHandle = GUI:ButtonCreate(_Parent,"button1",1850700010,497,4)
    if _GUIHandle ~= 0 then
        GUI:WndRegistScript(_GUIHandle,RDWndBaseCL_mouse_lbUp, "ShenLuWnd.XueFu")
    end
    ...
    _GUIHandle = GUI:ButtonCreate(_Parent,"button2",1850700014,645,4)
    if _GUIHandle ~= 0 then
        GUI:WndRegistScript(_GUIHandle,RDWndBaseCL_mouse_lbUp, "ShenLuWnd.HuDun")
    end
    ...
    _GUIHandle = GUI:ButtonCreate(_Parent,"button3",1850700018,793,4)
    if _GUIHandle ~= 0 then
        GUI:WndRegistScript(_GUIHandle,RDWndBaseCL_mouse_lbUp, "ShenLuWnd.BaoShi")
    end
    ...
    _GUIHandle = GUI:ButtonCreate(_Parent,"button4",1850700022,941,4)
    if _GUIHandle ~= 0 then
        GUI:WndRegistScript(_GUIHandle,RDWndBaseCL_mouse_lbUp, "ShenLuWnd.HunZhu")
    end
    ...
    _GUIHandle = GUI:EditCreate(_Parent,"sm2",670,314,65,32)
    if _GUIHandle ~= 0 then
        GUI:WndSetTextColorM(_GUIHandle, GUI:MakeARGB(255,180,255,160))
    end
    
    _GUIHandle = GUI:EditCreate(_Parent,"sm1",670,339,65,32)
    if _GUIHandle ~= 0 then
        GUI:WndSetTextColorM(_GUIHandle, GUI:MakeARGB(255,180,255,160))
    end
    
    _GUIHandle = GUI:EditCreate(_Parent,"sm3",670,362,65,32)
    if _GUIHandle ~= 0 then
        GUI:WndSetTextColorM(_GUIHandle, GUI:MakeARGB(255,180,255,160))
    end
    
    _GUIHandle = GUI:EditCreate(_Parent,"sz2",727,318,80,26)
    if _GUIHandle ~= 0 then
    end
    
    _GUIHandle = GUI:EditCreate(_Parent,"sz1",727,343,80,26)
    if _GUIHandle ~= 0 then
    end
    
    _GUIHandle = GUI:EditCreate(_Parent,"sz3",727,366,80,26)
    if _GUIHandle ~= 0 then
    end
    
    _GUIHandle = GUI:EditCreate(_Parent,"hsm2",870,314,65,32)
    if _GUIHandle ~= 0 then
        GUI:WndSetTextColorM(_GUIHandle, GUI:MakeARGB(255,180,255,160))
    end
    
    _GUIHandle = GUI:EditCreate(_Parent,"hsm1",870,339,65,32)
    if _GUIHandle ~= 0 then
        GUI:WndSetTextColorM(_GUIHandle, GUI:MakeARGB(255,180,255,160))
    end
    
    _GUIHandle = GUI:EditCreate(_Parent,"hsm3",870,362,65,32)
    if _GUIHandle ~= 0 then
        GUI:WndSetTextColorM(_GUIHandle, GUI:MakeARGB(255,180,255,160))
    end
    
    _GUIHandle = GUI:EditCreate(_Parent,"hsz2",930,318,80,26)
    if _GUIHandle ~= 0 then
    end
    
    _GUIHandle = GUI:EditCreate(_Parent,"hsz1",930,343,80,26)
    if _GUIHandle ~= 0 then
    end
    
    _GUIHandle = GUI:EditCreate(_Parent,"hsz3",930,366,80,26)
    if _GUIHandle ~= 0 then
    end
    
    _GUIHandle = GUI:EditCreate(_Parent,"sm4",91,345,0,0)
    if _GUIHandle ~= 0 then
        GUI:WndSetTextColorM(_GUIHandle, GUI:MakeARGB(255,180,255,160))
    end
    
    _GUIHandle = GUI:EditCreate(_Parent,"sz4",185,344,0,0)
    if _GUIHandle ~= 0 then
        GUI:EditSetFontCenter(_GUIHandle)
    end
    
    _GUIHandle = GUI:EditCreate(_Parent,"sm5",90,391,0,0)
    if _GUIHandle ~= 0 then
        GUI:WndSetTextColorM(_GUIHandle, GUI:MakeARGB(255,180,255,160))
    end
    
    _GUIHandle = GUI:EditCreate(_Parent,"sz5",185,389,0,0)
    if _GUIHandle ~= 0 then
        GUI:WndSetTextColorM(_GUIHandle, GUI:MakeARGB(255,180,255,160))
        GUI:EditSetFontCenter(_GUIHandle)
    end
    ...
    if _GUIHandle ~= 0 then
        GUI:WndRegistScript(_GUIHandle,RDWndBaseCL_mouse_lbUp, "ShenLuWnd.get")
    ...
    if _GUIHandle ~= 0 then
        GUI:WndRegistScript(_GUIHandle,RDWndBaseCL_mouse_lbUp, "ShenLuWnd.buy")
    ...
    if _GUIHandle ~= 0 then
        GUI:WndRegistScript(_GUIHandle,RDWndBaseCL_mouse_lbUp, "ShenLuWnd.elseitem")
        GUI:RichEditSetEditEnable(_GUIHandle, false)
        GUI:RichEditAppendString(_GUIHandle, "")
    end
...
function ShenLuWnd.UIInit(_GUIHandle)
	...
	local BgImg = GUI:WndFindWindow(ShenLuWnd.WndHandle, "BgImage")
    if BgImg then
    ...
    --第二层背景
    local BgImg0 = GUI:WndFindWindow(ShenLuWnd.WndHandle, "BgImage0")
    if BgImg0 then
     ...
     --第三层背景
    local BgImg1 = GUI:WndFindWindow(ShenLuWnd.WndHandle, "BgImage1")
    if BgImg1 then
    ...
    local BgImg2 = GUI:WndFindWindow(ShenLuWnd.WndHandle, "BgImage2")
    if BgImg2 then
    ...
    local BgImg2 = GUI:WndFindWindow(ShenLuWnd.WndHandle, "gong_image1")
    if BgImg2 then
    ...
    local BgImg2 = GUI:WndFindWindow(ShenLuWnd.WndHandle, "gong_image2")
    if BgImg2 then
        GUI:ImageSetAroundImage(BgImg2, 1850600034, 1850600036, 1850600040, 1850600042, 1850600038, 1850600035, 1850600041, 1850600037, 1850600039)
    end 
	...
	local _handle = 0;
	for i = 1, 4 do
		_handle = GUI:WndFindChildM(ShenLuWnd.WndHandle, "button"..i)
	...
	_handle = GetWindow(ShenLuWnd.WndHandle,"ShenLuWnd,item",nil)
	if _handle ~= 0 then
	 	ShenLuWnd._control["item"] = _handle 
	end
	ShenLuWnd.XueFu(ShenLuWnd._control["button1"])
	UI:Lua_SubmitForm("神炉表单", "xuefu", "")
	_handle = GUI:WndFindChildM(ShenLuWnd.WndHandle, "smBtn")
	if _handle ~= 0 then
...
function ShenLuWnd.XueFu(_handle)
	...
	if not Is_true then
		...
		UI:Lua_SubmitForm("神炉表单", "xuefu", "")
		GUI:WndSetHint(ShenLuWnd._control["sm7"], hint[1])
	end	
	--GUI:WndSetVisible(ShenLuWnd.WndHandle,"sm6",false)
...
function ShenLuWnd.HuDun(_handle)
	...
	if not Is_true then
		...
		GUI:WndSetHint(ShenLuWnd._control["sm7"], hint[2])
	end
...
function ShenLuWnd.BaoShi(_handle)
	...
	if not Is_true then
		...
		GUI:WndSetHint(ShenLuWnd._control["sm7"], hint[3])
	end	
end
function ShenLuWnd.HunZhu(_handle)
	...
	if not Is_true then
		...
		GUI:WndSetHint(ShenLuWnd._control["sm7"], hint[4])
	end
end
...
function ShenLuWnd.updata(data,tb)
	...
	for i = 1 , 8 do 
		...
		elseif i >= 4 and i <= 5 then 
			EditSetText(ShenLuWnd.WndHandle,"sm"..i,"")
		elseif i > 5 then
			GUI:RichEditClear(ShenLuWnd._control["sm"..i])
		end
	end
	for i = 1 , 8 do 
		if i < 4 then
		...
		elseif i >= 4 and i <= 5 then 
			EditSetText(ShenLuWnd.WndHandle,"sm"..i,str[index][i])
		elseif i > 5 then
			GUI:RichEditAppendString(ShenLuWnd._control["sm"..i],str[index][i])
		end
	end
	ShenLuWnd.need = tonumber(data[4])		--下一级需要的积分
	...
	if index == 1 then
		...
		UI:Lua_Log("1111   ShenLuWnd._control item = ".. ShenLuWnd._control["item"].." xuefu_tab[xuefu_nextlv] = "..xuefu_tab[xuefu_nextlv].."xuefu_nextlv = "..xuefu_nextlv)
		ShenLuWnd.InitItemInfoByKeyName(ShenLuWnd._control["item"], xuefu_tab[xuefu_nextlv])
		if xuefu_lv <= 0 then
	...
	elseif index == 2 then
		...
		UI:Lua_Log("22222")
		ShenLuWnd.InitItemInfoByKeyName(ShenLuWnd._control["item"], hudun_tab[hudun_nextlv])
		if hudun_lv <= 0 then
			EditSetText(ShenLuWnd.WndHandle,"sz1","0")
	...
	elseif index == 3 then
		...
		UI:Lua_Log("3333")
		ShenLuWnd.InitItemInfoByKeyName(ShenLuWnd._control["item"], baoshi_tab[baoshi_nextlv])
		if baoshi_lv <= 0 then
			EditSetText(ShenLuWnd.WndHandle,"sz1","0")
			EditSetText(ShenLuWnd.WndHandle,"sz2","0")
	...
	elseif index == 4 then
		...
		UI:Lua_Log("4444")
		ShenLuWnd.InitItemInfoByKeyName(ShenLuWnd._control["item"], hunzhu_tab[hunzhu_nextlv])
		if hunzhu_lv <= 0 then
			EditSetText(ShenLuWnd.WndHandle,"sz1","0")
			EditSetText(ShenLuWnd.WndHandle,"sz2","0")
		else
...
function ShenLuWnd.get(_handle)
	...
	if get_index == 1 then 
		UI:Lua_SubmitForm("神炉表单", "get_xuefu", ""..ShenLuWnd.ElseItem)
	elseif get_index == 2 then
		UI:Lua_SubmitForm("神炉表单", "get_hudun", ""..ShenLuWnd.ElseItem)
	elseif get_index == 3 then
		UI:Lua_SubmitForm("神炉表单", "get_baoshi", ""..ShenLuWnd.ElseItem)
	elseif get_index == 4 then
		UI:Lua_SubmitForm("神炉表单", "get_hunzhu", ""..ShenLuWnd.ElseItem)
	end
	UI:Lua_SubmitForm("神炉表单", "ShowTolNum", "")
end	

function ShenLuWnd.closeWnd(_handle)	
	--GUI:WndClose(ShenLuWnd.WndHandle)
end

function ShenLuWnd.InitItemInfoByKeyName(_WndHandle, KeyName)
...
function ShenLuWnd.msg_up(str)
	local _handle = GUI:WndFindChildM(ShenLuWnd.WndHandle, "msg")
	if _handle ~= 0 then
		GUI:EditSetTextM(_handle, str)
	end
	if ShenLuWnd.DelayTaskId ~= nil then
		CL:DelDelayTask(ShenLuWnd.DelayTaskId)
		ShenLuWnd.DelayTaskId = nil
	end
	ShenLuWnd.DelayTaskId = CL:AddDelayTask("ShenLuWnd.ClearMsg()", 3000, 1)
end

function ShenLuWnd.ClearMsg()
	local _handle = GUI:WndFindChildM(ShenLuWnd.WndHandle, "msg")
	if _handle ~= 0 then
