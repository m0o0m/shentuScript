...
function SettingPickup.main()
    local ui = "<form default_parent='GameSettingDlg'> <dialog OnInit='	.UIInit' id='SettingPickup' image='' x='19' y='68' w='579' h='296' revmsg='true'>"
...
function SettingPickup.inputNum(_Handle)
	if _Handle ~= 0 then 
		local level = GUI:EditGetTextM(_Handle)
