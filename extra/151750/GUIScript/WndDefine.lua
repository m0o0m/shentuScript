...
--RDWndDlg
i = 17000
rdwnddlg_pos_change              =i;  LuaUIEvent[i] ="OnPosChange"       ;i=i+1
rdwnddlg_pos_top              =i;  LuaUIEvent[i] ="OnPosTop"       ;i=i+1
rdwnddlg_pos_bot              =i;  LuaUIEvent[i] ="OnPosBot"       ;i=i+1
...
ITEMWINDOW_EHANCE2				=i;i=i+1--精炼2
ITEMWINDOW_HEROPACKAGE			=i;i=i+1--英雄面板
ITEMWINDOW_ROLEEQUIPMENT		=i;i=i+1--人物装备面板
