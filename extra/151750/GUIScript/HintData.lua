...
HintData[0] = { "1|HintDialog_0",
				"image = 1,1904100005,0,0,0,0;\
				edit = edit_no_use, 0, 0, 0, 0;\
				oninit = HINTFUNC_0_INIT;\
				position = 0,0;\
				image = 0,1904100010,0,0,0,0,0;\
				edit = e, 220, 100, 357, 68,, #COLORCOLOR_BROWN#   欢迎来到《神途》您将踏上神途的旅途，请问您是\n否需要我来给您介绍下我们游戏呢？#COLOREND#;\
				edit = e1, 230, 160, 100, 30, HINTFUNC_0_EDIT, #SELECT##COLORCOLOR_YELLOW#我是老手，不需要#SELECTEND#;\
				button = b, 370, 165, 1904100074, HINTFUNC_0_BUTTON;"}

HintData[1] = { "1|HintDialog_1",
				"image = 1,1904100005,0,0,0,0; image = 5,1904100078,0,0,0,0;\
				oninit = HINTFUNC_1_INIT;\
				alive_time = 3000, HINTFUNC_1_ATIME;\
				timer = 10, HINTFUNC_1_TIMER;\
				edit = e, 0, 0, 1024, 0, HINTFUNC_1_EDIT;"}

HintData[2] = { "1|HintDialog_2",
				"image = 1,1904100005,0,0,0,0; image = 9,1904100092,10000,0,0,0;\
				oninit = HINTFUNC_2_INIT; timer = 10,HINTFUNC_2_TIMER;\
				alive_time = 60000,HINTFUNC_2_ATIME;\
				edit = e, 0, 0, 0, 0, HINTFUNC_2_ATIME;"}

HintData[20] = { "1|HintDialog_20",
				"image = 6,1904100001,0,0,244,70; image = 0,1904100013,10,0,0,0; image = 0,1904100016,98,65,0,0;\
				edit = e, 64, 0, 175, 64,, #COLORCOLOR_WHITE#\n请#COLORCOLOR_YELLOW#鼠标左键#COLORCOLOR_WHITE#点击移动到这里#COLOREND#;\
				edit = e1, 76, 80, 80, 80, HINTFUNC_20_EDIT;\
				timer = 300, HINTFUNC_20_TIMER;\
				oninit = HINTFUNC_20_INIT;"}
				
HintData[21] = { "1|HintDialog_21",
				"script = |1005,HINTFUNC_21_SCRIPT;\
				image = 6,1904100001,0,0,264,88; image = 0,1904100014,10,10,0,0; image = 0,1904100016,108,83,0,0; image = 0,1043000016,94,115,0,0;\
				edit = e, 66, 0, 188, 88,, #COLORCOLOR_WHITE#\n一直#COLORCOLOR_YELLOW#按住右键#COLORCOLOR_WHITE#，快速跑动到这里\n \n注意：当背包里东西超重时就不\n能跑步了。#COLOREND#;\
				timer = 300, HINTFUNC_21_TIMER; ontimer = 1, 30, HINTFUNC_21_TIMER1;\
				oninit = HINTFUNC_21_INIT;"}
