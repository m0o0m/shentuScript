...
<quests>
	<quest id="952" name="#COLORCOLOR_YELLOW#[经验、功勋] #COLORCOLOR_ORANGE#功勋除魔" type="2" suggest_level="1" visible="1">
		<script name="除魔任务" />
		<description>
		...
		<tracker>
			<progressing>
			<![CDATA[#LINK<MAP:祖玛寺庙一层,POSX:79,POSY:120,STR:杀死邪庙任意12只怪物,MOVE:1># #MONSTERGROUP0#]]>
			</progressing>
			<accomplishing>
