...
<quests>
	<quest id="100" name="#COLORCOLOR_YELLOW#[主线] #COLORCOLOR_ORANGE#强化1件+8的装备" type="1" suggest_level="1" visible="1" next_id="101">
		<script name="任务执行脚本" />
		<description>
			强化可以快速提升自己的实力，说再多不如你去试一试，去升级1件+8的装备看看。
		</description>
		<dialogue>
			<brief>强化可以快速提升自己的实力，说再多不如你去试一试，去升级1件+8的装备看看。</brief>
