...
<quests>
	<quest id="134" name="#COLORCOLOR_YELLOW#[主线] #COLORCOLOR_ORANGE#穿戴4件80级以上装备" type="1" suggest_level="1" visible="1" next_id="135">
		<script name="任务执行脚本" />
		<description>
			接下来的挑战，会更加有难度，所以你没有更好的装备，就不要去送死了，先去穿戴4件80级的装备保护好自己再来吧。
		</description>
		<dialogue>
			<brief>接下来的挑战，会更加有难度，所以你没有更好的装备，就不要去送死了，先去穿戴4件80级的装备保护好自己再来吧。</brief>
...
任务奖励：#COLORCOLOR_MAGENTA#600万经验#COLOREND# #MONSTERGROUP0#]]>
		...
		<rewards exp="6000000" ingot="0" bind_ingot="0" integral="0" gold="0" bind_gold="500000" >
		</rewards>
		<auto>
