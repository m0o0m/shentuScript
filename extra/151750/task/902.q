...
<quests>
	<quest id="902" name="#COLORCOLOR_YELLOW#[经验、功勋] #COLORCOLOR_ORANGE#功勋除魔" type="2" suggest_level="1" visible="1" next_id="">
		<script name="除魔任务" />
		<description>
		...
		<tracker>
			<progressing>
			<![CDATA[#LINK<MAP:蜈蚣洞一层,POSX:72,POSY:134,STR:杀死毒虫洞任意12只怪物,MOVE:1># #MONSTERGROUP0#]]>
			</progressing>
			<accomplishing>
