...
<quests>
	<quest id="157" name="#COLORCOLOR_YELLOW#[主线]  #COLORCOLOR_ORANGE#达到100级" type="1" suggest_level="1" visible="1" next_id="158">
		<script name="任务执行脚本" />
		<description>
			等级不足，还谈什么人生，说什么理想？不用多说了，先去升到100级吧。
		</description>
		<dialogue>
			<brief>等级不足，还谈什么人生，说什么理想？不用多说了，先去升到100级吧。</brief>
			<await>找不到路？没关系，任务追踪点击可自动带你前往。速去速回。</await>
			<finish>恭喜达到100级，海量任务正等着你呢。</finish>
		</dialogue>
		<requirements>
...
#COLORCOLOR_BROWN#安全升级：#COLOREND# #NPCLINK<STR:野外挂机,NPCKEYNAME:巫山城传送员,MOVE:1>#]]>
		...
		<rewards exp="2500000" ingot="0" bind_ingot="0" integral="0" gold="0" bind_gold="100000" >
		</rewards>
		<auto>
