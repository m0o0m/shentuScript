...
<quests>
	<quest id="147" name="#COLORCOLOR_YELLOW#[主线]  #COLORCOLOR_ORANGE#达到93级" type="1" suggest_level="1" visible="1" next_id="148">
		<script name="任务执行脚本" />
		<description>
			等级不足，还谈什么人生，说什么理想？不用多说了，先去升到93级吧。
		</description>
		<dialogue>
			<brief>等级不足，还谈什么人生，说什么理想？不用多说了，先去升到93级吧。</brief>
			<await>找不到路？没关系，任务追踪点击可自动带你前往。速去速回。</await>
			<finish>恭喜达到93级，海量任务正等着你呢。</finish>
		</dialogue>
		<requirements>
