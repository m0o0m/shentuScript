...
<quests>
	<quest id="5001" name="#COLORCOLOR_YELLOW#[经验、材料] #COLORCOLOR_ORANGE#副本" type="3" suggest_level="1" visible="1" next_id="">
		<description>
		...
		<tracker>
			<progressing>
			<![CDATA[击杀 #LINK<MAP:新手村,POSX:34,POSY:40,STR:BOSS># #MONSTERGROUP0#]]>
			</progressing>
			<accomplishing>
			<![CDATA[#NPCLINK<STR:副本使节,NPCKEYNAME:巫山城副本使节>#]]>
			</accomplishing>
		</tracker>
		<achievements>
