...
<quests>
	<quest id="10001" name="测试测试" type="2" suggest_level="1" visible="1">
		<description>
			去矿洞里面帮我挖8个矿来，就给你三块金砖。怎么样？条件够诱人了吧？哈哈，有钱大家一起赚。
		</description>
		<dialogue>
			<brief>去矿洞里面帮我挖8块矿来，就给你三块金砖。怎么样？条件够诱人了吧？哈哈，有钱大家一起赚。</brief>
		...
		<requirements>
			...
			<level enable="1" min_num="65" max_num="200" />
			<jobs>
				<job id="1" />
				<job id="2" />
				<job id="3" />
