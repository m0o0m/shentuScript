...
<quests>
	<quest id="105" name="#COLORCOLOR_YELLOW#[主线] #COLORCOLOR_ORANGE#强化2件+8的装备" type="1" suggest_level="1" visible="1" next_id="106">
		<script name="任务执行脚本" />
		<description>
			强化可以快速提升自己的实力，说再多不如你去试一试，去升级2件+8的装备看看。
		</description>
		<dialogue>
...
任务奖励：#COLORCOLOR_MAGENTA#500万经验#COLOREND# #MONSTERGROUP0#]]>
			</progressing>
			<accomplishing>
