...
<quests>
	<quest id="1006" name="#COLORCOLOR_YELLOW#[经验、功勋] #COLORCOLOR_ORANGE#功勋除魔" type="2" suggest_level="1" visible="1" next_id="">
		<script name="除魔任务" />
		<description>
		...
		<tracker>
			<progressing>
			<![CDATA[#LINK<MAP:赤月神殿二层,POSX:49,POSY:69,STR:杀死魔月峡谷任意20只怪物,MOVE:1># #MONSTERGROUP0#]]>
			</progressing>
			<accomplishing>
